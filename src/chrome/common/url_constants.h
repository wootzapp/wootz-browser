...
inline constexpr char16_t kHistorySearchSettingURL[] =
    u"wootzapp://settings/historySearch";
...
inline constexpr char16_t kHistorySearchV2SettingURL[] =
    u"wootzapp://settings/ai/historySearch";
...
// The URL path to Wootzapp's Privacy Policy page.
inline constexpr char kPrivacyPolicyURL[] =
    "https://www.wootzapp.com/privacy";

// The URL path to Wootzapp's Privacy Policy page for users in China.
inline constexpr char kPrivacyPolicyURLChina[] =
    "https://www.wootzapp.com/privacy";

// The URL path to Wootzapp's Embedded Privacy Policy page.
inline constexpr char kPrivacyPolicyOnlineURLPath[] =
    "https://www.wootzapp.com/privacy/embedded";

// The URL path to Wootzapp's Embedded Privacy Policy page for users in China.
