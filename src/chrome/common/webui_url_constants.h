...
extern const char kChromeUIDonutsURL[];
extern const char kChromeUIDonutsHost[];
...
extern const char kChromeUIHelloWalletHost[];
extern const char kChromeUIHelloWalletURL[];
...
extern const char kChromeUIWalletHost[];
