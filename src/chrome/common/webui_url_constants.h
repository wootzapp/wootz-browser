...
inline constexpr char kChromeUIAboutURL[] = "wootzapp://about/";
inline constexpr char kChromeUIExtensionStoreHost[] = "flow-store";
inline constexpr char kChromeUIExtensionStoreURL[] = "wootzapp://flow-store/";
inline constexpr char kChromeUIStartupCrxInstallHost[] = "startup-crx-install";
inline constexpr char kChromeUIStartupCrxInstallURL[] = "wootzapp://startup-crx-install/";
...
inline constexpr char kChromeUIBookmarksURL[] = "wootzapp://bookmarks/";
...
inline constexpr char kChromeUIChromeURLsHost[] = "wootzapp-urls";
inline constexpr char kChromeUIChromeURLsURL[] = "wootzapp://wootzapp-urls/";
inline constexpr char16_t kChromeUIChromeURLsURL16[] = u"wootzapp://wootzapp-urls/";
...
inline constexpr char kChromeUIDownloadsURL[] = "wootzapp://downloads/";
...
inline constexpr char kChromeUIExtensionIconURL[] = "wootzapp://extension-icon/";
inline constexpr char kChromeUIExtensionsHost[] = "extensions";
inline constexpr char kChromeUIExtensionsInternalsHost[] =
    "extensions-internals";
inline constexpr char kChromeUIExtensionsURL[] = "wootzapp://extensions/";
...
inline constexpr char kChromeUIHistoryURL[] = "wootzapp://history/";
inline constexpr char16_t kChromeUIHistoryURL16[] = u"wootzapp://history/";
...
inline constexpr char kChromeUINetInternalsURL[] = "wootzapp://net-internals/";
inline constexpr char kChromeUIThrottleHost[] = "throttle";
inline constexpr char kChromeUIThrottleURL[] = "wootzapp://throttle/";
inline constexpr char kChromeUIReactHost[] = "react";
inline constexpr char kChromeUIReactURL[] = "wootzapp://react/";
...
inline constexpr char kChromeUINewTabPageURL[] = "wootzapp://new-tab-page/";
inline constexpr char kChromeUINewTabURL[] = "wootzapp://newtab/";
inline constexpr char kChromeUIHelloWorldURL[] = "wootzapp://rewards/";
inline constexpr char kChromeUIHelloWorldHost[] = "rewards";
inline constexpr char kChromeUINewTabFooterURL[] = "wootzapp://newtab-footer/";
...
inline constexpr char16_t kChromeUIPrivacySandboxFledgeURL[] =
    u"wootzapp://settings/adPrivacy/sites";
...
inline constexpr char kChromeUIQuitURL[] = "wootzapp://quit/";
...
inline constexpr char kChromeUIRestartURL[] = "wootzapp://restart/";
...
inline constexpr char kChromeUISettingsURL[] = "wootzapp://settings/";
inline constexpr char16_t kChromeUISettingsURL16[] = u"wootzapp://settings/";
...
inline constexpr char kChromeUIJavaCrashURL[] = "wootzapp://java-crash/";
