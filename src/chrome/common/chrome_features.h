...
// #if BUILDFLAG(ENABLE_EXTENSIONS_CORE) //wootz extension
COMPONENT_EXPORT(CHROME_FEATURES) BASE_DECLARE_FEATURE(kOnConnectNative);
COMPONENT_EXPORT(CHROME_FEATURES) BASE_DECLARE_FEATURE(kExtensionDeferredIndividualSettings); //check, not available in 137v
// #endif
