...
base::span<const base::cstring_view> ChromeURLHosts() {
  static constexpr auto kChromeURLHosts = std::to_array<base::cstring_view>({
      ...
      kChromeUIExtensionStoreHost,
      kChromeUIExtensionStoreURL,
      kChromeUIThrottleURL,
      kChromeUIThrottleHost,
      kChromeUIReactHost,
      kChromeUIReactURL,
      kChromeUIHelloWorldURL,
      kChromeUIHelloWorldHost,
      kChromeUIStartupCrxInstallHost,
      kChromeUIStartupCrxInstallURL,
