...
const char kChromeUIDonutsURL[] = "chrome://donuts/";
...
const char kChromeUIHelloWalletHost[] = "hello-wallet";
const char kChromeUIHelloWalletURL[] = "chrome://hello-wallet/";
...
const char kChromeUIWalletHost[] = "wallet";
