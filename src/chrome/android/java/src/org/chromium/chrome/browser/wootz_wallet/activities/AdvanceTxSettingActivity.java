...
public class AdvanceTxSettingActivity extends WootzWalletBaseActivity {
    ...
    protected void triggerLayoutInflation() {
        ...
        setupWootzToolBar(R.string.wootz_wallet_advanced_settings);
    ...
    private void setupWootzToolBar(@StringRes int title) {
