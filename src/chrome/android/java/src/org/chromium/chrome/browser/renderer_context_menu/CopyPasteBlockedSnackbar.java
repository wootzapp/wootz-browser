...
public class CopyPasteBlockedSnackbar {
    ...
    // Responsive: reduce padding for compact look
    ...
    contentContainer.setPadding(paddingH, paddingV, paddingH, paddingV);
    ...
    circleParams.setMargins(0, 0, (int) (16 * context.getResources().getDisplayMetrics().density), 0);
    ...
    titleText.setPadding(0, 0, 0, (int) (6 * context.getResources().getDisplayMetrics().density));
    ...
    // Responsive: set snackbar container width to MATCH_PARENT and dynamic margins
    int marginH = (int) (16 * context.getResources().getDisplayMetrics().density);
    // Move the snackbar a bit higher by increasing the bottom margin (e.g., from 40dp to 80dp)
    int marginBottom = (int) (30 * context.getResources().getDisplayMetrics().density);
    LinearLayout.LayoutParams containerParams = new LinearLayout.LayoutParams(
        LinearLayout.LayoutParams.MATCH_PARENT,
        LinearLayout.LayoutParams.WRAP_CONTENT);
    containerParams.gravity = Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL;
    containerParams.setMargins(marginH, 0, marginH, marginBottom);
