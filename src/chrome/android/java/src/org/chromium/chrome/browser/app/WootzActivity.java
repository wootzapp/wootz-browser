...
/** Wootz's extension for ChromeActivity */
@JNINamespace("chrome::android")
public abstract class WootzActivity extends ChromeActivity
        implements 
    ...
    // public static final String WOOTZ_REWARDS_SETTINGS_URL = "brave://rewards/";
    // public static final String WOOTZ_REWARDS_SETTINGS_WALLET_VERIFICATION_URL =
    //         "brave://rewards/#verify";
    // public static final String WOOTZ_REWARDS_WALLET_RECONNECT_URL = "brave://rewards/reconnect";
    // public static final String WOOTZ_REWARDS_SETTINGS_MONTHLY_URL = "brave://rewards/#monthly";
    // public static final String REWARDS_AC_SETTINGS_URL = "brave://rewards/contribute";
    // public static final String WOOTZ_REWARDS_RESET_PAGE = "brave://rewards/#reset";
    // public static final String WOOTZ_AI_CHAT_URL = "chrome-untrusted://chat";
    // public static final String REWARDS_LEARN_MORE_URL =
    //         "https://brave.com/faq-rewards/#unclaimed-funds";
    // public static final String WOOTZ_TERMS_PAGE =
    //         "https://basicattentiontoken.org/user-terms-of-service/";
    // public static final String WOOTZ_PRIVACY_POLICY = "https://brave.com/privacy/browser/#rewards";
    ...
    // public static final String WOOTZ_SEARCH_ENGINE_KEYWORD = ":br";
    ...
    /** Serves as a general exception for failed attempts to get WootzActivity. */
    public static class WootzActivityNotFoundException extends Exception {
        public WootzActivityNotFoundException(String message) {
            super(message);
        }
    }

    public WootzActivity() {}
    ...
    @NonNull
    public static WootzActivity getWootzActivity() throws WootzActivityNotFoundException {
        WootzActivity activity = (WootzActivity) getActivityOfType(WootzActivity.class);
        if (activity != null) {
            return activity;
        }

        throw new WootzActivityNotFoundException("WootzActivity Not Found");
    }
