...
import org.chromium.chrome.browser.firstrun.WootzFirstRunFlowSequencer;
...
public class WootzVpnSupportActivity extends AsyncInitializationActivity {
    private WootzFirstRunFlowSequencer mFirstRunFlowSequencer;
    private final OneshotSupplier<ProfileProvider> mProfileSupplier;

    public WootzVpnSupportActivity() {
        mProfileSupplier = createProfileProvider();
    }

    private void initializeViews() {
        setContentView(R.layout.activity_wootz_vpn_support);
            ...
            public void onClick(View v) {
                ...
                if (appVersionSwitch.isChecked()) {
                    bodyText.append(String.format(
                            ...
                            AboutChromeSettings.getApplicationVersion(WootzVpnSupportActivity.this,
    ...
    protected void triggerLayoutInflation() {
        mFirstRunFlowSequencer =
                new WootzFirstRunFlowSequencer(mProfileSupplier) {
                    @Override
    ...
    private void composeEmail(String body) {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, new String[] {"wootzandroid@guardianapp.com"});
        intent.putExtra(Intent.EXTRA_SUBJECT, "Wootz Firewall + VPN Issue");
