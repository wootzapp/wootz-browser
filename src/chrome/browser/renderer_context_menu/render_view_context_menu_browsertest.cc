...
IN_PROC_BROWSER_TEST_P(ContextMenuBrowserTest,
  ...
  std::unique_ptr<TestRenderViewContextMenu> menu2 =
      CreateContextMenuMediaTypeNone(GURL("wootzapp://history"), GURL());
...
class ContextMenuForLockedFullscreenBrowserTest
 ...
 protected:
  void SetUpOnMainThread() override {
    ...
    OpenUrlWithDisposition(GURL("wootzapp://new-tab-page/"),
                           WindowOpenDisposition::CURRENT_TAB);
    OpenUrlWithDisposition(GURL("wootzapp://version/"),
                           WindowOpenDisposition::CURRENT_TAB);
