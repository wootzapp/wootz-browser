...
#include "chrome/browser/ephemeral_storage/wootz_ephemeral_storage_service_delegate.h"
...
WootzEphemeralStorageServiceDelegate::WootzEphemeralStorageServiceDelegate(
...
void WootzEphemeralStorageServiceDelegate::CleanupTLDEphemeralArea(
...
void WootzEphemeralStorageServiceDelegate::CleanupFirstPartyStorageArea(
