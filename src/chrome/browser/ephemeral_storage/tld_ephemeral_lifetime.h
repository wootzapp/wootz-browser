...
#ifndef CHROME_BROWSER_EPHEMERAL_STORAGE_TLD_EPHEMERAL_LIFETIME_H_
#define CHROME_BROWSER_EPHEMERAL_STORAGE_TLD_EPHEMERAL_LIFETIME_H_
...
#endif  // CHROME_BROWSER_EPHEMERAL_STORAGE_TLD_EPHEMERAL_LIFETIME_H_
