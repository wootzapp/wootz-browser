...
import { type GetPostOnRampQuoteParams } from "../../../../pay/buyWithFiat/getPostOnRampQuote.js";
/**
 * @internal
 */
export type PostOnRampQuoteQueryOptions = Omit<UseQueryOptions<BuyWithCryptoQuote>, "queryFn" | "queryKey" | "enabled">;
/**
 ...
 * @buyCrypto
 */
export declare function usePostOnRampQuote(params?: GetPostOnRampQuoteParams, queryOptions?: PostOnRampQuoteQueryOptions): UseQueryResult<BuyWithCryptoQuote>;
//# sourceMappingURL=usePostOnrampQuote.d.ts.map