...
const localWalletLocaleVi = {
    passwordLabel: "Mật khẩu",
    confirmPasswordLabel: "Xác nhận mật khẩu",
    enterYourPassword: "Nhập mật khẩu của bạn",
    warningScreen: {
        title: "Cảnh báo",
        warning: "Ví hiện tại sẽ bị xoá nếu bạn tạo một ví mới. Hãy cân nhắc sao lưu ví về thiết bị",
    ...
    createScreen: {
        instruction: "Chọn một mật khẩu cho ví của bạn. Bạn có thể dùng mật khẩu đã đặt để truy cập và sao lưu ví sau này",
    ...
    importScreen: {
        title: "Thêm ví mới",
        description1: "Ứng dụng này có thể tự do giao dịch mà không cần sự cho phép của bạn",
        description2: "Bạn chỉ nên kết nối ví với những ứng dụng đáng tin cậy",
        passwordDescription: "Chọn một mật khẩu để mã hoá private key. Private key đã mã hoá sẽ được lưu trên trình duyệt",
        import: "Thêm",
...
exports.default = localWalletLocaleVi;
