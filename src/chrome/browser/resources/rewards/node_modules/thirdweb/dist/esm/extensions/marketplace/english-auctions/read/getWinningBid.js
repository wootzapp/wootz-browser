...
import { getWinningBid as getWinningBidGenerated, } from "../../__generated__/IEnglishAuctions/read/getWinningBid.js";
/**
...
export async function getWinningBid(options) {
    const [bidderAddress, currencyAddress, bidAmountWei] = await getWinningBidGenerated(options);
