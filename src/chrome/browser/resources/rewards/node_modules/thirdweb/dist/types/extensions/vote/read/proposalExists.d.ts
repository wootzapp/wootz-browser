...
import { type StateParams } from "../__generated__/Vote/read/state.js";
/**
 ...
 * ```
 */
export declare function proposalExists(options: BaseTransactionOptions<StateParams>): Promise<boolean>;
//# sourceMappingURL=proposalExists.d.ts.map