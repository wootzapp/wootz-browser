...
const localWalletLocaleEn = {
    ...
    warningScreen: {
        title: "警告",
        warning: "新しいウォレットを作成すると、現在のウォレットが削除されます。新しいウォレットを作成する前に、ウォレットをデバイスにバックアップしてください",
    ...
    createScreen: {
        instruction: "ウォレットのパスワードを選択してください。同じパスワードでこのウォレットにアクセスしてエクスポートできます",
        importWallet: "ウォレットをインポート",
        createNewWallet: "新しいウォレットを作成",
        connecting: "接続中",
    },
    exportScreen: {
        downloadMessage: "これにより、ウォレットの秘密鍵を含むテキストファイルがデバイスにダウンロードされます",
    ...
    importScreen: {
        title: "ウォレットをインポート",
        description1: "アプリケーションは、ウォレットの代理として任意のトランザクションを承認できます",
        description2: "信頼できるアプリケーションにのみ接続することをお勧めします",
        passwordDescription: "秘密鍵を暗号化するためのパスワードを選択してください。暗号化された秘密鍵はブラウザに保存されます",
        import: "インポート",
