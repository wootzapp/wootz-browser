...
import { type ProposalVotesParams } from "../__generated__/Vote/read/proposalVotes.js";
import type { VoteType } from "../types.js";
export type ProposalVoteInfo = {
    [K in keyof typeof VoteType]: bigint;
};
/**
 ...
 * ```
 */
export declare function getProposalVoteCounts(options: BaseTransactionOptions<ProposalVotesParams>): Promise<ProposalVoteInfo>;
//# sourceMappingURL=getProposalVoteCounts.d.ts.map