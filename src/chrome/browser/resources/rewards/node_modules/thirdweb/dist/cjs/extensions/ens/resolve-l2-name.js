...
exports.convertReverseNodeToBytes = void 0;
...
const convertReverseNodeToBytes = (address, chainId) => {
    ...
    const addressNode = (0, viem_1.keccak256)(addressFormatted.substring(2));
    const cointype = (0x80000000 | chainId) >>> 0;
    const chainCoinType = cointype.toString(16).toLocaleUpperCase();
    const reverseNode = (0, viem_1.namehash)(`${chainCoinType.toLocaleUpperCase()}.reverse`);
    const addressReverseNode = (0, viem_1.keccak256)((0, viem_1.encodePacked)(["bytes32", "bytes32"], [reverseNode, addressNode]));
    return addressReverseNode;
};
exports.convertReverseNodeToBytes = convertReverseNodeToBytes;
/**
...
async function resolveL2Name(options) {
    ...
    return (0, withCache_js_1.withCache)(async () => {
        ...
        const reverseName = (0, exports.convertReverseNodeToBytes)(address, resolverChain.id || 1);
