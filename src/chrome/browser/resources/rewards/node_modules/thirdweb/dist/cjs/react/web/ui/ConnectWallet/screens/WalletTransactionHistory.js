...
function WalletTransactionHistory(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { scrollY: true, flex: "column", fullHeight: true, style: {
            ...
            paddingBottom: index_js_1.spacing.lg,
        }, children: (0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "column", gap: "xs", expand: true, children: transactions.length === 0 ? ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "md", center: "both", color: "secondaryText", style: {
                    flex: "1",
                    minHeight: "250px",
                    ...
                    return ((0, jsx_runtime_1.jsx)(TransactionButton, { explorerUrl: chainExplorers.explorers[0]?.url, client: props.client, hash: tx.transactionHash, chainId: tx.chainId }, tx.transactionHash));
                }) })) }) }));
}
function TransactionButton(props) {
    const { data: receipt, isLoading, error, } = (0, useWaitForReceipt_js_1.useWaitForReceipt)({
        transactionHash: props.hash,
        chain: (0, utils_js_1.getCachedChain)(props.chainId),
        client: props.client,
    });
    const chainIconQuery = (0, useChainQuery_js_1.useChainIconUrl)((0, utils_js_1.getCachedChain)(props.chainId));
