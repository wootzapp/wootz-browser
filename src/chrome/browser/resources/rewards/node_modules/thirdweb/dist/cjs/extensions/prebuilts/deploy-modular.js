...
async function deployModularContract(options) {
    const { chain, client, account, publisher, core, params: coreParams, modules = [], } = options;
...
async function getInitializeTransaction(options) {
    const { client, implementationContract, contractId, coreParams, modules, accountAddress, chain, account, } = options;
