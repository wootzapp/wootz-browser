import type { EIP1193RequestFn, EIP1474Methods, RpcTransactionRequest } from "viem";
/**
 ...
 * ```
 */
export declare function eth_estimateGas(request: EIP1193RequestFn<EIP1474Methods>, transactionRequest: RpcTransactionRequest): Promise<bigint>;
