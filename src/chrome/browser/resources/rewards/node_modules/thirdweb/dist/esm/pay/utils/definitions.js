 ...
 * @internal
 */
export const getPayBuyWithCryptoStatusUrl = () => `${getPayBaseUrl()}/buy-with-crypto/status/v1`;
/**
 * Endpoint to get "Buy with Crypto" quote.
 * @internal
 */
export const getPayBuyWithCryptoQuoteEndpoint = () => `${getPayBaseUrl()}/buy-with-crypto/quote/v1`;
/**
 * Endpoint to get "Buy with Crypto" transfer.
 * @internal
 */
export const getPayBuyWithCryptoTransferEndpoint = () => `${getPayBaseUrl()}/buy-with-crypto/transfer/v1`;
/**
 * Endpoint to get a "Buy with Fiat" quote.
 * @internal
 */
export const getPayBuyWithFiatQuoteEndpoint = () => `${getPayBaseUrl()}/buy-with-fiat/quote/v1`;
/**
 * Endpoint to get the status of a "Buy with Fiat" transaction status.
 * @internal
 */
export const getPayBuyWithFiatStatusEndpoint = () => `${getPayBaseUrl()}/buy-with-fiat/status/v1`;
/**
 ...
 * @internal
 */
export const getPaySupportedDestinations = () => `${getPayBaseUrl()}/destination-tokens/v1`;
/**
 * Endpoint to get a list of supported source chains + tokens for thirdweb pay.
 * @internal
 */
export const getPaySupportedSources = () => `${getPayBaseUrl()}/buy-with-crypto/source-tokens/v1`;
/**
