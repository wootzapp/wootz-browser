 ...
 */
export declare function generateMerkleTreeInfoERC1155(options: BaseTransactionOptions<GenerateMerkleTreeInfoERC1155Params>): Promise<{
    merkleRoot: string;
    snapshotUri: string;
}>;
//# sourceMappingURL=merkleInfoERC1155.d.ts.map