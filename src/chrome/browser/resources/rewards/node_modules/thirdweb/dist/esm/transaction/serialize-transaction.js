import { serializeTransaction as _serializeTransaction, } from "viem";
/**
...
export function serializeTransaction(options) {
    ...
    return _serializeTransaction(transaction, signature); // Trust the options type-checking did its job and that the converted signature mirrors that type
}
