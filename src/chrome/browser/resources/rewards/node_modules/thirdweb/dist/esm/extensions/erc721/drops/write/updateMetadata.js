 ...
 * @internal
 */
export async function getUpdateMetadataParams(options) {
    ...
    const currentMetadatas = await Promise.all(range.map((id) => GetNFT.getNFT({ contract, tokenId: id, includeOwner: false })));
