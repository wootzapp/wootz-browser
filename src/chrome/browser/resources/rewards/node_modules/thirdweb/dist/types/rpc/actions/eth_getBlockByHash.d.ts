import { type EIP1193RequestFn, type EIP1474Methods, type GetBlockReturnType, type Hash } from "viem";
 ...
 * ```
 */
export declare function eth_getBlockByHash<TIncludeTransactions extends boolean = false>(request: EIP1193RequestFn<EIP1474Methods>, params: GetBlockByHashParams<TIncludeTransactions>): Promise<GetBlockReturnType<undefined, TIncludeTransactions>>;
export {};
