...
type To = "hex" | "bytes";
type Keccak256Hash<TTo extends To> = (TTo extends "bytes" ? Uint8Array : never) | (TTo extends "hex" ? Hex : never);
/**
 ...
 * @utils
 */
export declare function keccak256<TTo extends To = "hex">(value: Hex | Uint8Array, to?: TTo): Keccak256Hash<TTo>;
export {};
