...
export async function getWalletInfo(id, image) {
    ...
    switch (id) {
        ...
        case "io.uptn": {
            return (image
                ? import("./wallet/io.uptn/image.js").then((img) => img.default)
                : import("./wallet/io.uptn/index.js").then((w) => w.wallet));
        }
        ...
        case "io.leapwallet.CompassWallet": {
            return (image
                ? import("./wallet/io.leapwallet.CompassWallet/image.js").then((img) => img.default)
                : import("./wallet/io.leapwallet.CompassWallet/index.js").then((w) => w.wallet));
        }
        case "com.lootrush": {
            return (image
