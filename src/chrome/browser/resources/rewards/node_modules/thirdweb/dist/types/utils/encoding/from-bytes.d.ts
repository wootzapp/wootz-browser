 ...
 * @utils
 */
export declare function fromBytes<TTo extends "string" | "hex" | "bigint" | "number" | "boolean">(bytes: Uint8Array, toOrOpts: FromBytesParameters<TTo>): FromBytesReturnType<TTo>;
 ...
 * @utils
 */
export declare function bytesToBigInt(bytes: Uint8Array, opts?: BytesToBigIntOpts): bigint;
 ...
 * @utils
 */
export declare function bytesToBool(bytes_: Uint8Array, opts?: BytesToBoolOpts): boolean;
 ...
 * @utils
 */
export declare function bytesToNumber(bytes: Uint8Array, opts?: BytesToNumberOpts): number;
 ...
 * @utils
 */
export declare function bytesToString(bytes_: Uint8Array, opts?: BytesToStringOpts): string;
//# sourceMappingURL=from-bytes.d.ts.map