...
export type WalletCapabilitiesRecord<capabilities extends WalletCapabilities, id extends string | number = Hex> = {
    [chain in id]: capabilities;
} & {
    message?: string;
};
export type WalletSendCallsParameters<capabilities extends WalletCapabilities = WalletCapabilities, chainId extends Hex | number = Hex> = [
    {
        from: Address;
        calls: EIP5792Call[];
