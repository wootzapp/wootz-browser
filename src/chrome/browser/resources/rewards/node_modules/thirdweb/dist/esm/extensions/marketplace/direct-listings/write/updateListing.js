...
export function updateListing(options) {
    return generatedUpdateListing({
        ...
        asyncParams: async () => {
            ...
            let startTimestamp = BigInt(Math.floor((mergedOptions.startTimestamp ?? new Date()).getTime() / 1000));
            const endTimestamp = BigInt(Math.floor((mergedOptions.endTimestamp ??
