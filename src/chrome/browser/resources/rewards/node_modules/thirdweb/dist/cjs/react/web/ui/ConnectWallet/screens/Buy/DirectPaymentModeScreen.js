...
function DirectPaymentModeScreen(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { p: "lg", children: [(0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { title: metadata?.name || "Payment Details" }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { children: [metadata?.image ? ((0, jsx_runtime_1.jsx)(Img_js_1.Img, { client: client, src: metadata?.image, style: {
                            width: "100%",
