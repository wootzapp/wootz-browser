 ...
 */
export declare function eip7702Actions(): <account extends Account | undefined = Account | undefined>(client: Client<Transport, Chain | undefined, account>) => Eip7702Actions<account>;
