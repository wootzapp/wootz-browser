...
describe("HMAC-SHA256", function () {
    it("should produce correct hashes for test vectors", function () {
        for (var i = 0; i < input.length; i++) {
            var h = new hmac_1.HMAC(sha256_1.SHA256, input.subarray(0, i));
            h.update(input.subarray(0, i));
            expect(base64_1.encode(h.digest())).toBe(vectors256[i]);
        }
    });
    it("should correctly update multiple times", function () {
        var h1 = new hmac_1.HMAC(sha256_1.SHA256, key);
        h1.update(input.subarray(0, 1));
        h1.update(input.subarray(1, 120));
        h1.update(input.subarray(120, 256));
        var h2 = new hmac_1.HMAC(sha256_1.SHA256, key);
    ...
    it("should return the same digest after finalizing", function () {
        var h = new hmac_1.HMAC(sha256_1.SHA256, key);
        h.update(input);
        var d1 = h.digest();
        var d2 = h.digest();
...
describe("HMAC-SHA224", function () {
    it("should produce correct hashes for test vectors", function () {
        for (var i = 0; i < input.length; i++) {
            var h = new hmac_1.HMAC(sha224_1.SHA224, input.subarray(0, i));
            h.update(input.subarray(0, i));
            expect(base64_1.encode(h.digest())).toBe(vectors224[i]);
        }
    });
    it("should return the same digest after finalizing", function () {
        var h = new hmac_1.HMAC(sha224_1.SHA224, key);
        h.update(input);
        var d1 = h.digest();
        var d2 = h.digest();
        expect(base64_1.encode(d1)).toBe(base64_1.encode(d2));
...
describe("hmac", function () {
    it("should produce correct hashes for test vectors", function () {
        for (var i = 0; i < input.length; i++) {
            var digest = hmac_1.hmac(sha256_1.SHA256, input.subarray(0, i), input.subarray(0, i));
            expect(base64_1.encode(digest)).toBe(vectors256[i]);
        }
    });
});
