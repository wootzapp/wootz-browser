...
import { D as Driver, S as StorageValue, a as Storage$1 } from './shared/unstorage.28bc67f1.mjs';
export { c as StorageMeta, T as TransactionOptions, U as Unwatch, b as WatchCallback, W as WatchEvent } from './shared/unstorage.28bc67f1.mjs';
import Redis, { RedisOptions as RedisOptions$1, ClusterNode, ClusterOptions, Cluster } from 'ioredis';
...
import { SecretClientOptions, SecretClient } from '@azure/keyvault-secrets';
...
declare const _default$m: (opts: VercelKVOptions) => Driver<VercelKVOptions, VercelKV>;
...
declare const _default$l: (opts: SessionStorageOptions) => Driver<SessionStorageOptions, Storage>;
...
declare const _default$k: (opts: RedisOptions) => Driver<RedisOptions, Redis | Cluster>;
...
declare const _default$j: (opts: PlanetscaleDriverOptions) => Driver<PlanetscaleDriverOptions, Connection>;
...
declare const _default$i: (opts: OverlayStorageOptions) => Driver<OverlayStorageOptions, never>;
...
declare const _default$h: (opts: NetlifyStoreOptions) => Driver<NetlifyStoreOptions, Store>;
...
declare const _default$g: (opts: MongoDbOptions) => Driver<MongoDbOptions, Collection<mongodb.Document>>;
...
declare const _default$f: (opts: void) => Driver<void, Map<string, any>>;
...
declare const _default$e: (opts: LRUDriverOptions) => Driver<LRUDriverOptions, LRUCache<string, any, any>>;
...
declare const _default$d: (opts: LocalStorageOptions) => Driver<LocalStorageOptions, Storage>;
...
declare const _default$c: (opts: IDBKeyvalOptions) => Driver<IDBKeyvalOptions, never>;
...
declare const _default$b: (opts: HTTPOptions) => Driver<HTTPOptions, never>;
...
declare const _default$a: (opts: GithubOptions) => Driver<GithubOptions, never>;
...
declare const _default$9: (opts: FSStorageOptions$1) => Driver<FSStorageOptions$1, never>;
...
declare const _default$8: (opts: FSStorageOptions) => Driver<FSStorageOptions, never>;
...
declare const _default$7: (opts: CloudflareR2Options) => Driver<CloudflareR2Options, R2Bucket>;
...
declare const _default$6: (opts: KVHTTPOptions) => Driver<KVHTTPOptions, never>;
...
declare const _default$5: (opts: KVOptions) => Driver<KVOptions, KVNamespace<string>>;
...
declare const _default$4: (opts: AzureStorageTableOptions) => Driver<AzureStorageTableOptions, TableClient>;
...
declare const _default$3: (opts: AzureStorageBlobOptions) => Driver<AzureStorageBlobOptions, ContainerClient>;
...
declare const _default$2: (opts: AzureKeyVaultOptions) => Driver<AzureKeyVaultOptions, SecretClient>;
...
declare const _default$1: (opts: AzureCosmosOptions) => Driver<AzureCosmosOptions, Promise<Container>>;
...
declare const _default: (opts: AzureAppConfigurationOptions) => Driver<AzureAppConfigurationOptions, AppConfigurationClient>;
...
declare function prefixStorage<T extends StorageValue>(storage: Storage$1<T>, base: string): Storage$1<T>;
...
export { type BuiltinDriverName, type BuiltinDriverOptions, type CreateStorageOptions, Driver, type Snapshot, Storage$1 as Storage, StorageValue, builtinDrivers, createStorage, defineDriver, joinKeys, normalizeBaseKey, normalizeKey, prefixStorage, restoreSnapshot, snapshot };
