...
import { RpcProvidersMap, RpcProviderMap, RequestParams, RequestArguments, SessionNamespace, NamespaceConfig, ConnectParams, IEthereumProvider } from "./misc";
...
export interface IUniversalProvider extends IEthereumProvider {
    ...
    sendAsync: (args: RequestArguments, callback: (error: Error | null, response: JsonRpcResult) => void, chain?: string) => void;
