...
#ifndef CHROME_BROWSER_UI_WEBUI_WOOTZ_WALLET_LINE_CHART_LINE_CHART_UI_H_
#define CHROME_BROWSER_UI_WEBUI_WOOTZ_WALLET_LINE_CHART_LINE_CHART_UI_H_
...
#endif  // CHROME_BROWSER_UI_WEBUI_WOOTZ_WALLET_LINE_CHART_LINE_CHART_UI_H_
