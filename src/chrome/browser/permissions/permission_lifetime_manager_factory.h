...
#ifndef CHROME_BROWSER_PERMISSIONS_PERMISSION_LIFETIME_MANAGER_FACTORY_H_
#define CHROME_BROWSER_PERMISSIONS_PERMISSION_LIFETIME_MANAGER_FACTORY_H_
...
#endif  // CHROME_BROWSER_PERMISSIONS_PERMISSION_LIFETIME_MANAGER_FACTORY_H_
