...
#ifndef CHROME_BROWSER_WOOTZ_CONTENT_BROWSER_CLIENT_H_
#define CHROME_BROWSER_WOOTZ_CONTENT_BROWSER_CLIENT_H_
...
class WootzContentBrowserClient : public ChromeContentBrowserClient {
 public:
  WootzContentBrowserClient();
  WootzContentBrowserClient(const WootzContentBrowserClient&) = delete;
  WootzContentBrowserClient& operator=(const WootzContentBrowserClient&) =
      delete;
  ~WootzContentBrowserClient() override;
...
#endif  // CHROME_BROWSER_WOOTZ_CONTENT_BROWSER_CLIENT_H_
