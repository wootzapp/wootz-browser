...
#ifndef WOOTZ_BROWSER_WOOTZ_WALLET_SWAP_SERVICE_FACTORY_H_
#define WOOTZ_BROWSER_WOOTZ_WALLET_SWAP_SERVICE_FACTORY_H_
...
#endif  // WOOTZ_BROWSER_WOOTZ_WALLET_SWAP_SERVICE_FACTORY_H_
