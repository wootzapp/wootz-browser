...
public class DangerousDownloadDialog {
        ...
        private View createCustomDownloadBlockedSnackbarView(Context context, Callback<Boolean> callback) {
                ...
                // Reduce padding for a more compact snackbar
                ...
                // Move the snackbar higher by increasing the top margin (e.g., from 40dp to 80dp)
                int marginTop = (int) (20 * context.getResources().getDisplayMetrics().density);
                LinearLayout.LayoutParams containerParams = new LinearLayout.LayoutParams(
                        LinearLayout.LayoutParams.MATCH_PARENT,
                        LinearLayout.LayoutParams.WRAP_CONTENT
                );
                containerParams.gravity = Gravity.TOP | Gravity.CENTER_HORIZONTAL;
                containerParams.setMargins(marginH, marginTop, marginH, 0);
