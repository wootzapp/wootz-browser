...
#ifndef CHROME_COMPONENTS_CONSTANTS_URL_CONSTANTS_H_
#define CHROME_COMPONENTS_CONSTANTS_URL_CONSTANTS_H_
...
#endif  // WOOTZ_COMPONENTS_CONSTANTS_URL_CONSTANTS_H_
