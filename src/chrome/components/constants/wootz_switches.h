...
#ifndef CHROME_COMPONENTS_CONSTANTS_WOOTZ_SWITCHES_H_
#define CHROME_COMPONENTS_CONSTANTS_WOOTZ_SWITCHES_H_
...
#endif  // WOOTZ_COMPONENTS_CONSTANTS_WOOTZ_SWITCHES_H_
