...
#ifndef CHROME_COMPONENTS_DECENTRALIZED_DNS_CORE_PREF_NAMES_H_
#define CHROME_COMPONENTS_DECENTRALIZED_DNS_CORE_PREF_NAMES_H_
...
#endif  // WOOTZ_COMPONENTS_DECENTRALIZED_DNS_CORE_PREF_NAMES_H_
