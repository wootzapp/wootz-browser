...
#ifndef CHROME_COMPONENTS_DECENTRALIZED_DNS_CORE_CONSTANTS_H_
#define CHROME_COMPONENTS_DECENTRALIZED_DNS_CORE_CONSTANTS_H_
...
#endif  // WOOTZ_COMPONENTS_DECENTRALIZED_DNS_CORE_CONSTANTS_H_
