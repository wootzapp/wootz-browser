...
#ifndef CHROME_COMPONENTS_DECENTRALIZED_DNS_CORE_UTILS_H_
#define CHROME_COMPONENTS_DECENTRALIZED_DNS_CORE_UTILS_H_
...
#endif  // WOOTZ_COMPONENTS_DECENTRALIZED_DNS_CORE_UTILS_H_
