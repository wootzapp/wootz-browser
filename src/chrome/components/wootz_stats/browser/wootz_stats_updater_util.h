...
#ifndef CHROME_COMPONENTS_WOOTZ_STATS_BROWSER_WOOTZ_STATS_UPDATER_UTIL_H_
#define CHROME_COMPONENTS_WOOTZ_STATS_BROWSER_WOOTZ_STATS_UPDATER_UTIL_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_STATS_BROWSER_WOOTZ_STATS_UPDATER_UTIL_H_
