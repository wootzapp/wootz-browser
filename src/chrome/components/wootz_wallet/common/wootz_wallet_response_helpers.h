...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_COMMON_WOOTZ_WALLET_RESPONSE_HELPERS_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_COMMON_WOOTZ_WALLET_RESPONSE_HELPERS_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_COMMON_WOOTZ_WALLET_RESPONSE_HELPERS_H_
