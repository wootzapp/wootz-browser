...
#ifndef WOOTZ_COMPONENTS_WOOTZ_WALLET_COMMON_WOOTZ_WALLET_RESPONSE_HELPERS_H_
#define WOOTZ_COMPONENTS_WOOTZ_WALLET_COMMON_WOOTZ_WALLET_RESPONSE_HELPERS_H_
