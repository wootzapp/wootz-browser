...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_COMMON_BTC_LIKE_SERIALIZER_STREAM_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_COMMON_BTC_LIKE_SERIALIZER_STREAM_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_COMMON_BTC_LIKE_SERIALIZER_STREAM_H_
