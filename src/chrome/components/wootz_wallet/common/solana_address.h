...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_COMMON_SOLANA_ADDRESS_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_COMMON_SOLANA_ADDRESS_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_COMMON_SOLANA_ADDRESS_H_
