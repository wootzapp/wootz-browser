...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_COMMON_WOOTZ_WALLET_CONSTANTS_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_COMMON_WOOTZ_WALLET_CONSTANTS_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_COMMON_WOOTZ_WALLET_CONSTANTS_H_
