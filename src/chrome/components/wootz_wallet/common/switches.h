...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_COMMON_SWITCHES_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_COMMON_SWITCHES_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_COMMON_SWITCHES_H_
