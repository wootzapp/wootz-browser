...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_COMMON_ETH_SIGN_TYPED_DATA_HELPER_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_COMMON_ETH_SIGN_TYPED_DATA_HELPER_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_COMMON_ETH_SIGN_TYPED_DATA_HELPER_H_
