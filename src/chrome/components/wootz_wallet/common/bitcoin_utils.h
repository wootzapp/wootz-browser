...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_COMMON_BITCOIN_UTILS_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_COMMON_BITCOIN_UTILS_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_COMMON_BITCOIN_UTILS_H_
