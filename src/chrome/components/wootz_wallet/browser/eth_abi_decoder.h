...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_ETH_ABI_DECODER_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_ETH_ABI_DECODER_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_ETH_ABI_DECODER_H_
