...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_FIL_REQUESTS_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_FIL_REQUESTS_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_FIL_REQUESTS_H_
