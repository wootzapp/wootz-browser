...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_KEYRING_SERVICE_PREFS_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_KEYRING_SERVICE_PREFS_H_

#include <string>

#include "chrome/components/wootz_wallet/common/wootz_wallet.mojom.h"  // IWYU pragma: keep
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_KEYRING_SERVICE_PREFS_H_
