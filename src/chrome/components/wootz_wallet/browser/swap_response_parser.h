...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_SWAP_RESPONSE_PARSER_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_SWAP_RESPONSE_PARSER_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_SWAP_RESPONSE_PARSER_H_
