...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_ZCASH_TX_MANAGER_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_ZCASH_TX_MANAGER_H_
...
#include "chrome/components/wootz_wallet/browser/tx_manager.h"
#include "chrome/components/wootz_wallet/browser/zcash/zcash_block_tracker.h"
#include "chrome/components/wootz_wallet/browser/zcash/zcash_rpc.h"
#include "chrome/components/wootz_wallet/browser/zcash/zcash_transaction.h"
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_ZCASH_TX_MANAGER_H_
