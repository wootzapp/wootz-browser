...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_ZCASH_ZCASH_WALLET_SERVICE_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_ZCASH_ZCASH_WALLET_SERVICE_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_ZCASH_ZCASH_WALLET_SERVICE_H_
