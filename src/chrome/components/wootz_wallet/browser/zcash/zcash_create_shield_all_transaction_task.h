...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_ZCASH_CREATE_SHIELD_ALL_TRANSACTION_TASK_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_ZCASH_CREATE_SHIELD_ALL_TRANSACTION_TASK_H_

#include <set>
#include <string>

#include "chrome/components/wootz_wallet/browser/internal/orchard_bundle_manager.h"
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_ZCASH_CREATE_SHIELD_ALL_TRANSACTION_TASK_H_
