...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_ETH_NONCE_TRACKER_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_ETH_NONCE_TRACKER_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_ETH_NONCE_TRACKER_H_
