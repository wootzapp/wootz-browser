...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_KEYRING_SERVICE_OBSERVER_BASE_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_KEYRING_SERVICE_OBSERVER_BASE_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_KEYRING_SERVICE_OBSERVER_BASE_H_
