...
#ifndef WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_KEYRING_SERVICE_OBSERVER_BASE_H_
#define WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_KEYRING_SERVICE_OBSERVER_BASE_H_
