...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_WOOTZ_WALLET_IPFS_SERVICE_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_WOOTZ_WALLET_IPFS_SERVICE_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_WOOTZ_WALLET_IPFS_SERVICE_H_
