...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_SIMPLE_HASH_CLIENT_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_SIMPLE_HASH_CLIENT_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_SIMPLE_HASH_CLIENT_H_
