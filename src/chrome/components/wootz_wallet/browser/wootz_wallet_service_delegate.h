...
#ifndef WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_WOOTZ_WALLET_SERVICE_DELEGATE_H_
#define WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_WOOTZ_WALLET_SERVICE_DELEGATE_H_
