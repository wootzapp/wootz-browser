...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_PASSWORD_ENCRYPTOR_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_PASSWORD_ENCRYPTOR_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_PASSWORD_ENCRYPTOR_H_
