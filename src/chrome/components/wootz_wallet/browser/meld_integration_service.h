...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_MELD_INTEGRATION_SERVICE_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_MELD_INTEGRATION_SERVICE_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_MELD_INTEGRATION_SERVICE_H_
