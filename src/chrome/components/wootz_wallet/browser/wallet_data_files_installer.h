...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_WALLET_DATA_FILES_INSTALLER_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_WALLET_DATA_FILES_INSTALLER_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_WALLET_DATA_FILES_INSTALLER_H_
