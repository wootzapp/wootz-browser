...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_ASSET_DISCOVERY_TASK_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_ASSET_DISCOVERY_TASK_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_ASSET_DISCOVERY_TASK_H_
