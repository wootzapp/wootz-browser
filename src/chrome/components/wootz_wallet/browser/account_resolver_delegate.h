...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_ACCOUNT_RESOLVER_DELEGATE_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_ACCOUNT_RESOLVER_DELEGATE_H_
...
class AccountResolverDelegate {
 public:
  ...
  virtual bool ValidateAccountId(const mojom::AccountIdPtr& account_id) = 0;
   ...
   //
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_ACCOUNT_RESOLVER_DELEGATE_H_
