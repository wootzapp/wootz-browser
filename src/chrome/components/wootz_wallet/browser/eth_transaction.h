...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_ETH_TRANSACTION_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_ETH_TRANSACTION_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_ETH_TRANSACTION_H_
