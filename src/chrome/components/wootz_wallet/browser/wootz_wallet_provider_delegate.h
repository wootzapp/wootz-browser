...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_WOOTZ_WALLET_PROVIDER_DELEGATE_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_WOOTZ_WALLET_PROVIDER_DELEGATE_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_WOOTZ_WALLET_PROVIDER_DELEGATE_H_
