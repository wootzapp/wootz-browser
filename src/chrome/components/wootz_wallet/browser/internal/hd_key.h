...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_INTERNAL_HD_KEY_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_INTERNAL_HD_KEY_H_
...
#include "chrome/components/wootz_wallet/common/mem_utils.h"
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_INTERNAL_HD_KEY_H_
