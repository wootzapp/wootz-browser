...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_SCOPED_TXS_UPDATE_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_SCOPED_TXS_UPDATE_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_SCOPED_TXS_UPDATE_H_
