...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_BITCOIN_BITCOIN_KNAPSACK_SOLVER_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_BITCOIN_BITCOIN_KNAPSACK_SOLVER_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_BITCOIN_BITCOIN_KNAPSACK_SOLVER_H_
