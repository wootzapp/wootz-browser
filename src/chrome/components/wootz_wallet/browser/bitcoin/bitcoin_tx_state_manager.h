...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_BITCOIN_BITCOIN_TX_STATE_MANAGER_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_BITCOIN_BITCOIN_TX_STATE_MANAGER_H_

#include <memory>
#include <string>

#include "chrome/components/wootz_wallet/browser/tx_state_manager.h"
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_BITCOIN_BITCOIN_TX_STATE_MANAGER_H_
