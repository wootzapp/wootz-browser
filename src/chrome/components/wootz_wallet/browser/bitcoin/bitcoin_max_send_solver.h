...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_BITCOIN_BITCOIN_MAX_SEND_SOLVER_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_BITCOIN_BITCOIN_MAX_SEND_SOLVER_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_BITCOIN_BITCOIN_MAX_SEND_SOLVER_H_
