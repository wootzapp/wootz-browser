...
#ifndef CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_SOLANA_COMPILED_INSTRUCTION_H_
#define CHROME_COMPONENTS_WOOTZ_WALLET_BROWSER_SOLANA_COMPILED_INSTRUCTION_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_WALLET_BROWSER_SOLANA_COMPILED_INSTRUCTION_H_
