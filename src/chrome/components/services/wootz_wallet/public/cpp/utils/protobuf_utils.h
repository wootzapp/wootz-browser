...
#ifndef CHROME_COMPONENTS_SERVICES_WOOTZ_WALLET_PUBLIC_CPP_UTILS_PROTOBUF_UTILS_H_
#define CHROME_COMPONENTS_SERVICES_WOOTZ_WALLET_PUBLIC_CPP_UTILS_PROTOBUF_UTILS_H_
...
#endif  // WOOTZ_COMPONENTS_SERVICES_WOOTZ_WALLET_PUBLIC_CPP_UTILS_PROTOBUF_UTILS_H_
