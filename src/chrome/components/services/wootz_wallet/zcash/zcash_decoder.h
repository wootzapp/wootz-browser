...
#ifndef CHROME_COMPONENTS_SERVICES_WOOTZ_WALLET_ZCASH_ZCASH_DECODER_H_
#define CHROME_COMPONENTS_SERVICES_WOOTZ_WALLET_ZCASH_ZCASH_DECODER_H_
...
#endif  // WOOTZ_COMPONENTS_SERVICES_WOOTZ_WALLET_ZCASH_ZCASH_DECODER_H_
