...
#ifndef CHROME_COMPONENTS_TIME_PERIOD_STORAGE_WEEKLY_STORAGE_H_
#define CHROME_COMPONENTS_TIME_PERIOD_STORAGE_WEEKLY_STORAGE_H_
...
#endif  // CHROME_COMPONENTS_TIME_PERIOD_STORAGE_WEEKLY_STORAGE_H_
