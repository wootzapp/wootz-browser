...
#ifndef CHROME_COMPONENTS_API_REQUEST_HELPER_API_REQUEST_HELPER_H_
#define CHROME_COMPONENTS_API_REQUEST_HELPER_API_REQUEST_HELPER_H_
...
#endif  // WOOTZ_COMPONENTS_API_REQUEST_HELPER_API_REQUEST_HELPER_H_
