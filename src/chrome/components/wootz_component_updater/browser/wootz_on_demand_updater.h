...
#ifndef CHROME_COMPONENTS_WOOTZ_COMPONENT_UPDATER_BROWSER_WOOTZ_ON_DEMAND_UPDATER_H_
#define CHROME_COMPONENTS_WOOTZ_COMPONENT_UPDATER_BROWSER_WOOTZ_ON_DEMAND_UPDATER_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_COMPONENT_UPDATER_BROWSER_WOOTZ_ON_DEMAND_UPDATER_H_
