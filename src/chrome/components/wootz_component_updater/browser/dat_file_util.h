...
#ifndef CHROME_COMPONENTS_WOOTZ_COMPONENT_UPDATER_BROWSER_DAT_FILE_UTIL_H_
#define CHROME_COMPONENTS_WOOTZ_COMPONENT_UPDATER_BROWSER_DAT_FILE_UTIL_H_
...
#endif  // WOOTZ_COMPONENTS_WOOTZ_COMPONENT_UPDATER_BROWSER_DAT_FILE_UTIL_H_
