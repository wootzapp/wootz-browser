...
class WootzVPNRegionDataManager {
 public:
  WootzVPNRegionDataManager(
      scoped_refptr<network::SharedURLLoaderFactory> url_loader_factory,
      PrefService* local_prefs);
  ~WootzVPNRegionDataManager();
  WootzVPNRegionDataManager(const WootzVPNRegionDataManager&) = delete;
  WootzVPNRegionDataManager& operator=(const WootzVPNRegionDataManager&) =
      delete;
