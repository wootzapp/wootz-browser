...
enum class RequestTypeForUma {
  ...
  PERMISSION_STORAGE_ACCESS = 25,
  PERMISSION_CAMERA_PAN_TILT_ZOOM = 26,
  PERMISSION_WINDOW_MANAGEMENT = 27,
  PERMISSION_LOCAL_FONTS = 28,
  PERMISSION_IDLE_DETECTION = 29,
  PERMISSION_FILE_HANDLING = 30,
  // PERMISSION_U2F_API_REQUEST = 31,
  PERMISSION_TOP_LEVEL_STORAGE_ACCESS = 32,
  // PERMISSION_MIDI = 33,
  PERMISSION_FILE_SYSTEM_ACCESS = 34,
  CAPTURED_SURFACE_CONTROL = 35,
  PERMISSION_SMART_CARD = 36,
  PERMISSION_WEB_PRINTING = 37,
  PERMISSION_IDENTITY_PROVIDER = 38,
  PERMISSION_KEYBOARD_LOCK = 39,
  PERMISSION_POINTER_LOCK = 40,
  MULTIPLE_KEYBOARD_AND_POINTER_LOCK = 41,
