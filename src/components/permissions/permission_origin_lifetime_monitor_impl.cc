...
#include "chrome/browser/permissions/permission_origin_lifetime_monitor_impl.h"
...
// #include "chrome/components/ephemeral_storage/ephemeral_storage_service.h"
...
PermissionOriginLifetimeMonitorImpl::SubscribeToPermissionOriginDestruction(
  ...
  for (auto type : {RequestType::kWootzEthereum, RequestType::kWootzSolana}) {
