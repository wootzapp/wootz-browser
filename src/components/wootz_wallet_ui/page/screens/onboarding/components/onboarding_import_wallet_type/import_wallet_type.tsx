...
export const OnboardingImportWalletType = () => {
  ...
  return (
    <OnboardingContentLayout
      title={getLocale('wootzWalletImportWalletTypeTitle')}
    >
      <Column
        width='100%'
      ...
      >
        <ImportTypeAction
          title={getLocale('wootzWalletImportWalletTypeHotWalletTitle')}
        ...
        <ImportTypeAction
          title={getLocale('wootzWalletImportWalletTypeHardwareWalletTitle')}
          description={getLocale(
