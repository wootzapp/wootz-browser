...
const TermsOfUseText: React.FC<{}> = () => {
  const text = getLocaleWithTag('wootzWalletTermsOfServiceCheckboxText')
  return (
    <p key={text.duringTag}>
      {text.beforeTag}
      <TermsLink
        href='https://wootz.com/terms-of-use/'
        target='_blank'
...
export const OnboardingDisclosures = () => {
  ...
  return (
    <OnboardingContentLayout
      title={getLocale('wootzWalletDisclosuresTitle')}
      subTitle={getLocale('wootzWalletDisclosuresDescription')}
      padding='22px 0 36px'
    >
      <Checkbox
      ...
      >
        <CheckboxText>
          <p>{getLocale('wootzWalletSelfCustodyDisclosureCheckboxText')}</p>
        </CheckboxText>
      </Checkbox>
