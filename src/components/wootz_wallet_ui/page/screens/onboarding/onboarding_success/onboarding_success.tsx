...
export const OnboardingSuccess = () => {
  ...
  React.useEffect(() => {
    ...
    report(WootzWallet.OnboardingAction.Complete)
  ...
  return (
    ...
    >
      <IntroImg />
      <Title>{getLocale('wootzWalletOnboardingSuccessTitle')}</Title>
      <VerticalSpace space='16px' />
      <SubTitle>
        {getLocale('wootzWalletOnboardingSuccessDescription')}
      </SubTitle>
      <VerticalSpace space='100px' />
      <Column>
        <ContinueButton onClick={onComplete}>
          {getLocale('wootzWalletOnboardingSuccessGoToPortfolio')}
        </ContinueButton>
      </Column>
    </OnboardingContentLayout>
  )
