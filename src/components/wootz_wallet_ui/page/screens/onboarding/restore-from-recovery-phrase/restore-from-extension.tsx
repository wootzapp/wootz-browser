    ...
    switch (currentStep) {
      case 'currentPassword':
        return {
          title:
            restoreFrom === 'metamask'
              ? getLocale('wootzWalletMetaMaskExtensionDetected')
              : getLocale('wootzWalletCryptoWalletsDetected'),
          description:
            restoreFrom === 'metamask'
              ? getLocale('wootzWalletMetaMaskExtensionImportDescription')
              : getLocale('wootzWalletImportWootzLegacyDescription')
        }

      case 'newPassword':
        return {
          title: getLocale('wootzWalletCreatePasswordTitle'),
          description: getLocale('wootzWalletCreatePasswordDescription')
        }
      ...
      {!isCheckingExtensions && currentStep === 'currentPassword' && (
        <>
          ...
          <PasswordInput
            ...
            placeholder={
              restoreFrom === 'metamask'
                ? getLocale('wootzWalletMetaMaskPasswordInputPlaceholder')
                : getLocale('wootzWalletImportWootzLegacyInput')
            }
          ...
          >
            {getLocale('wootzWalletImportWithRecoveryPhrase')}
          </Button>
