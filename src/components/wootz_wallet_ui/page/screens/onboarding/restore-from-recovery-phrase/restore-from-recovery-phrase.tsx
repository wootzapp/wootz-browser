...
export const OnboardingRestoreFromRecoveryPhrase = () => {
  ...
  switch (currentStep) {
    case 'phrase':
      title = getLocale('wootzWalletRestoreMyWootzWallet')
      subTitle = getLocale('wootzWalletRestoreMyWootzWalletInstructions')
      break
    case 'password':
      title = getLocale('wootzWalletCreatePasswordTitle')
      subTitle = getLocale('wootzWalletCreatePasswordDescription')
      break
    default:
      title = ''
      subTitle = ''
  ...
  React.useEffect(() => {
    if (currentStep === 'password') {
      report(WootzWallet.OnboardingAction.LegalAndPassword)
    }
  }, [report, currentStep])
    ...
    >
      {currentStep === 'phrase' && (
        <>
          ...
          >
            {getLocale('wootzWalletRestoreAlternateLength').replace(
              '$1',
          ...
          {importableWallets?.isMetaMaskInitialized && (
            <AlertWrapper>
              <InfoAlert padding='0 0 16px 0'>
                ...
                {getLocale('wootzWalletMetamaskDetected')}
                <div slot='content-after'>
                  ...
                  >
                    {getLocale('wootzWalletUsePassword')}
                  </Button>
                </div>
              </InfoAlert>
            </AlertWrapper>
          ...
          {importableWallets?.isLegacyCryptoWalletsInitialized && (
            <AlertWrapper>
              <InfoAlert>
                ...
                {getLocale('wootzWalletLegacyWalletDetected')}
                <div slot='content-after'>
                  <Button
                    kind='plain'
                    size='small'
          ...
          hasInvalidSeedError ? (
            <InfoAlert
              ...
              type='error'
            >
              {getLocale('wootzWalletRestoreWalletError')}
            </InfoAlert>
          ) : (
