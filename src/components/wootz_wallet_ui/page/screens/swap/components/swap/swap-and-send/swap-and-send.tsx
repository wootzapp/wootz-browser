...
interface Props {
  ...
  selectedSwapSendAccount: WootzWallet.AccountInfo | undefined
...
export const SwapAndSend = (props: Props) => {
  ...
  return (
    ...
    >
      ...
      >
        <Row>
          <Text textSize='14px'>{getLocale('wootzSwapSwapAndSend')}</Text>
          <Flash
            name='flash'
            size={16}
          />
          <Text
            ...
            textColor='text03'
          >
            {getLocale('wootzSwapNoExtraFees')}
          </Text>
        </Row>
        <StandardSwitch
                    ...
                    toAnotherAddress !== '' && (
                      <>
                        ...
                        >
                          ...
                          <StandardCheckbox
                            id='confirm-address'
                            label={getLocale('wootzSwapConfirmAddress')}
