    ...
    >
      ...
      >
        <Text
          ...
          textAlign='left'
        >
          {getLocale('wootzWalletMaxSlippageDescription')}
        </Text>
        ...
        <Text
          ...
          textAlign='left'
        >
          {getLocale('wootzWalletSuggestedValues')}
        </Text>
        <VerticalSpace space='8px' />
        <Text
          isBold={false}
          ...
          textAlign='left'
        >
          {getLocale('wootzWalletMainstreamAssetPairs').replace(
            '$1',
        ...
        <Text
          ...
          textAlign='left'
        >
          {getLocale('wootzWalletStablecoinPairs').replace(
            '$1',
        ...
        <Text
          ...
          textAlign='left'
        >
          {getLocale('wootzWalletOthers').replace('$1', OTHERS_SLIPPAGE)}
        </Text>
      </Column>
      <Row gap='12px'>
        <OptionButton
        ...
        >
          <Column alignItems='flex-start' gap='8px'>
            <Text
              ...
              textColor='primary'
            >
              {getLocale('wootzWalletSuggested')}
            </Text>
            <Text
              isBold={true}
              textSize='16px'
