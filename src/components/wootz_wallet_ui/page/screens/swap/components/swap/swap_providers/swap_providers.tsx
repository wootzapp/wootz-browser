...
interface Props {
  selectedProvider: WootzWallet.SwapProvider
  onChangeSwapProvider: (provider: WootzWallet.SwapProvider) => void
  availableProvidersForSwap: WootzWallet.SwapProvider[]
}
...
export const SwapProviders = (props: Props) => {
  ...
  const [userSelectedSwapProvider, setUserSelectedSwapProvider] =
    React.useState<WootzWallet.SwapProvider>(selectedProvider)
    ...
    <Column fullWidth={true}>
      ...
      >
        <Text
          ...
          textColor='primary'
        >
          {getLocale('wootzWalletChooseQuoteProvider')}
        </Text>
        <HorizontalSpace space='8px' />
        <InfoIconTooltip
          placement='bottom'
          text={getLocale('wootzWalletQuoteProviderInfo')}
        />
      </Row>
      <Column
        fullWidth={true}
              ...
              >
                ...
                {!isAvailableForSwap && (
                  <Text
                    ...
                    textColor='disabled'
                  >
                    {getLocale('wootzWalletNotAvailable')}
                  </Text>
                )}
              </Row>
            </RadioButton>
