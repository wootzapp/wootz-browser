      ...
      >
        ...
        >
          <Text
            ...
            isBold={true}
          >
            {getLocale('wootzSwapPrivacyPolicy')}
          </Text>
        ...
        >
          <Text
            ...
            isBold={true}
          >
            {getLocale('wootzSwapPrivacyDescription')}
          </Text>
          ...
          >
            ...
            <Text
              ...
              isBold={true}
            >
              {getLocale('wootzSwapV2Disclaimer')
                .replaceAll('$1', '0x')
                .replace('$2', 'EVM')
                .replace('$3', 'Ethereum')}
            </Text>
            ...
            >
              {getLocale('wootzSwapV2Privacy').replace('$1', '0x')}
            </Link>
          </Section>
          ...
          >
            ...
            >
              {getLocale('wootzSwapV2Privacy').replace('$1', 'Jupiter')}
            </Link>
          </Section>
          <VerticalSpacer size={20} />
        </Column>
