...
import ButtonMenu from '@wootz/leo/react/buttonMenu'
      ...
      >
        ...
        >
          ...
          <leo-menu-item onClick={() => setSortBy('FASTEST')}>
            {getLocale('wootzWalletFastest')}
          </leo-menu-item>
          <leo-menu-item onClick={() => setSortBy('CHEAPEST')}>
            {getLocale('wootzWalletCheapest')}
          </leo-menu-item>
        </ButtonMenu>
      </Row>
      <ScrollableColumn
