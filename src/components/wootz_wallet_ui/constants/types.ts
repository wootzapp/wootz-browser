...
export type HardwareVendor =
  | typeof WootzWallet.TREZOR_HARDWARE_VENDOR
  | typeof WootzWallet.LEDGER_HARDWARE_VENDOR
...
export type SpotPriceRegistry = {
  [id: string]: WootzWallet.AssetPrice
}
...
export type NavTypes = 'crypto' | 'cards'
...
export interface ChartTimelineObjectType {
  abr: string
  name: string
  id: WootzWallet.AssetPriceTimeframe
}
...
export interface TokenRegistry {
  [chainID: string]: WootzWallet.BlockchainToken[]
}
...
export interface PanelState {
  hasInitialized: boolean
  connectToSiteOrigin: WootzWallet.OriginInfo
...
/**
 * Used to properly store WootzWallet.TransactionInfo in redux store,
...
export type SerializableSolanaTxDataSendOptions =
  | (Omit<Defined<WootzWallet.SolanaSendTransactionOptions>, 'maxRetries'> &
...
export type SerializableTxDataUnion = {
  ...
  ethTxData?: WootzWallet.TxData
  ethTxData1559?: WootzWallet.TxData1559
  filTxData?: WootzWallet.FilTxData
  btcTxData?: WootzWallet.BtcTxData
  zecTxData?: WootzWallet.ZecTxData
}
...
export type AllowSpendReturnPayload = {
  siteUrl: string
  contractAddress: string
  erc20Token: WootzWallet.BlockchainToken
...
export const BuySupportedChains = [
  ...
  WootzWallet.LOCALHOST_CHAIN_ID,
  WootzWallet.POLYGON_MAINNET_CHAIN_ID,
  WootzWallet.BNB_SMART_CHAIN_MAINNET_CHAIN_ID,
  WootzWallet.AVALANCHE_MAINNET_CHAIN_ID,
  WootzWallet.CELO_MAINNET_CHAIN_ID,
  WootzWallet.SOLANA_MAINNET,
  WootzWallet.OPTIMISM_MAINNET_CHAIN_ID,
  WootzWallet.FILECOIN_MAINNET,
  WootzWallet.FANTOM_MAINNET_CHAIN_ID
]
...
export interface TransactionProviderError {
  code: WootzWallet.ProviderErrorUnion
  message: string
}

export const emptyProviderErrorCodeUnion: WootzWallet.ProviderErrorUnion = {
...
export const SupportedCoinTypes = [
  ...
  WootzWallet.CoinType.ETH,
  WootzWallet.CoinType.FIL,
  WootzWallet.CoinType.BTC,
  WootzWallet.CoinType.ZEC
]

export const SupportedOnRampNetworks = [
  WootzWallet.SOLANA_MAINNET,
  WootzWallet.MAINNET_CHAIN_ID, // ETH
  WootzWallet.FILECOIN_MAINNET,
  WootzWallet.POLYGON_MAINNET_CHAIN_ID,
  WootzWallet.BNB_SMART_CHAIN_MAINNET_CHAIN_ID,
  WootzWallet.AVALANCHE_MAINNET_CHAIN_ID,
  ...
  WootzWallet.CELO_MAINNET_CHAIN_ID,
  WootzWallet.OPTIMISM_MAINNET_CHAIN_ID,
  WootzWallet.ARBITRUM_MAINNET_CHAIN_ID,
  WootzWallet.AURORA_MAINNET_CHAIN_ID,
...
export const SupportedTestNetworks = [
  WootzWallet.SEPOLIA_CHAIN_ID,
  WootzWallet.LOCALHOST_CHAIN_ID,
  WootzWallet.SOLANA_DEVNET,
  WootzWallet.SOLANA_TESTNET,
  WootzWallet.FILECOIN_TESTNET,
  WootzWallet.FILECOIN_ETHEREUM_TESTNET_CHAIN_ID,
  WootzWallet.BITCOIN_TESTNET,
  WootzWallet.Z_CASH_TESTNET
]

export const SupportedTestNetworkEntityIds: EntityId[] = [
  `${WootzWallet.LOCALHOST_CHAIN_ID}-${WootzWallet.CoinType.BTC}`,
  `${WootzWallet.LOCALHOST_CHAIN_ID}-${WootzWallet.CoinType.ETH}`,
  `${WootzWallet.LOCALHOST_CHAIN_ID}-${WootzWallet.CoinType.FIL}`,
  `${WootzWallet.LOCALHOST_CHAIN_ID}-${WootzWallet.CoinType.SOL}`,
  `${WootzWallet.LOCALHOST_CHAIN_ID}-${WootzWallet.CoinType.ZEC}`,
  WootzWallet.SEPOLIA_CHAIN_ID,
  WootzWallet.SOLANA_DEVNET,
  WootzWallet.SOLANA_TESTNET,
  WootzWallet.FILECOIN_TESTNET,
...
export const BitcoinMainnetKeyringIds = [
  WootzWallet.KeyringId.kBitcoin84,
  WootzWallet.KeyringId.kBitcoinImport
]
...
/**
 * Should match WootzWallet.CoinType defined with "as const" to allow for use
 * as a type-guard.
 */
...
export enum CoinTypesMap {
  ETH = WootzWallet.CoinType.ETH,
  FIL = WootzWallet.CoinType.FIL,
  SOL = WootzWallet.CoinType.SOL,
  BTC = WootzWallet.CoinType.BTC,
  ZEC = WootzWallet.CoinType.ZEC
}

export type BuyOption = {
  id: WootzWallet.OnRampProvider
  icon: string
  name: string
  description: string
  actionText: string
...
export type DAppPermissionDurationOption = {
  name: string
  id: WootzWallet.PermissionLifetimeOption
}
...
export const FilecoinNetworkLocaleMapping = {
  [WootzWallet.FILECOIN_MAINNET]: 'Filecoin Mainnet',
  [WootzWallet.FILECOIN_TESTNET]: 'Filecoin Testnet'
}
...
export const BitcoinNetworkLocaleMapping = {
  [WootzWallet.BITCOIN_MAINNET]: 'Bitcoin Mainnet',
  [WootzWallet.BITCOIN_TESTNET]: 'Bitcoin Testnet'
}

export const ZCashNetworkLocaleMapping = {
  [WootzWallet.Z_CASH_MAINNET]: 'ZCash Mainnet',
  [WootzWallet.Z_CASH_TESTNET]: 'ZCash Testnet'
}
...
export const SwapProviderNameMapping = {
  [WootzWallet.SwapProvider.kAuto]: 'Auto',
  [WootzWallet.SwapProvider.kJupiter]: 'Jupiter',
  [WootzWallet.SwapProvider.kZeroEx]: '0x',
  [WootzWallet.SwapProvider.kLiFi]: 'Li.Fi'
}

export const SupportedSwapProviders = [
  WootzWallet.SwapProvider.kAuto,
  WootzWallet.SwapProvider.kJupiter,
  WootzWallet.SwapProvider.kZeroEx,
  WootzWallet.SwapProvider.kLiFi
]
