...
type EIP1559SerializableTransactionInfo = SerializableTransactionInfo & {
  txDataUnion: { ethTxData1559: WootzWallet.TxData1559 }
}
...
export const getMockedTransactionInfo =
  (): EIP1559SerializableTransactionInfo => {
    return {
      ...
      txStatus: WootzWallet.TransactionStatus.Approved,
      txType: WootzWallet.TransactionType.Other,
      txParams: [],
      txArgs: [],
      ...
      originInfo: {
        originSpec: 'https://wootz.com',
        eTldPlusOne: 'wootz.com'
      },
...
export const mockNetwork: WootzWallet.NetworkInfo = {
  chainId: '0x1',
...
export const mockFilecoinEVMMMainnetNetwork: WootzWallet.NetworkInfo = {
  chainId: '0x13a',
...
export const mockFilecoinEVMMTestnetNetwork: WootzWallet.NetworkInfo = {
  chainId: '0x4cb2f',
...
export const mockBtcMainnetNetwork: WootzWallet.NetworkInfo = {
  chainId: 'bitcoin_mainnet',
  chainName: 'Bitcoin Mainnet',
  activeRpcEndpointIndex: 0,
  rpcEndpoints: [{ url: 'https://bitcoin-mainnet.wallet.wootz.com/' }],
...
export const mockAccount: WootzWallet.AccountInfo = {
...
export const mockBtcAccount: WootzWallet.AccountInfo = {
...
export const mockZecAccount: WootzWallet.AccountInfo = {
  name: 'mockZecAccountName',
  address: 'zCash-address',
  accountId: {
    coin: WootzWallet.CoinType.ZEC,
    keyringId: WootzWallet.KeyringId.kZCashMainnet,
    kind: WootzWallet.AccountKind.kDerived,
    address: 'zCash-address',
    accountIndex: 0,
...
export const mockEthAccountInfo: WootzWallet.AccountInfo = {
  hardware: undefined,
...
export const mockSolanaAccount: WootzWallet.AccountInfo = {
...
export const mockSolanaAccountInfo: WootzWallet.AccountInfo = {
  name: 'MockSolanaAccount',
...
export const mockFilecoinAccount: WootzWallet.AccountInfo = {
  name: 'MockFilecoinAccount',
  address: 't1alebc2ujfh4kuxs5bvzmx5b2w5ixrqrl3ni5rti',
  accountId: {
    coin: WootzWallet.CoinType.FIL,
    keyringId: WootzWallet.KeyringId.kFilecoinTestnet,
    kind: WootzWallet.AccountKind.kDerived,
    address: 't1alebc2ujfh4kuxs5bvzmx5b2w5ixrqrl3ni5rti',
    accountIndex: 0,
...
export const mockFilecoinAccountInfo: WootzWallet.AccountInfo = {
  name: 'MockFilecoinAccount',
  address: 't1alebc2ujfh4kuxs5bvzmx5b2w5ixrqrl3ni5rti',
  accountId: {
    coin: WootzWallet.CoinType.FIL,
...
export const mockBitcoinAccount: WootzWallet.AccountInfo = {
...
export const mockBitcoinTestAccount: WootzWallet.AccountInfo = {
  name: 'MockBitcoinTestAccount',
  address: '',
  accountId: {
    coin: WootzWallet.CoinType.BTC,
    keyringId: WootzWallet.KeyringId.kBitcoin84Testnet,
    kind: WootzWallet.AccountKind.kDerived,
    address: '',
    accountIndex: 0,
...
export const mockBitcoinTestnetAccount: WootzWallet.AccountInfo = {
...
WootzWallet.SignTransactionRequest = {
  ...
  txData: {
    ...
    solanaTxData: {
      ...
      version: WootzWallet.SolanaMessageVersion.kLegacy,
      messageHeader: {
...
// WootzWallet.TransactionInfo (selectedPendingTransaction)
      ...
      instructions: [
        {
          ...
          decodedData: {
            accountParams: [
              {
                localizedName: 'From',
                name: WootzWallet.FROM_ACCOUNT
              },
              {
                localizedName: 'To',
                name: WootzWallet.TO_ACCOUNT
              }
            ],
            instructionType: WootzWallet.SolanaSystemInstruction.kTransfer,
            params: [
              {
                localizedName: 'lamports',
                name: WootzWallet.LAMPORTS,
                value: '1',
                type: WootzWallet.SolanaInstructionParamType.kUint64
              }
            ]
          }
        }
...
// EVM Simulations
//
export const mockBlowfishAssetPrice: WootzWallet.BlowfishPrice = {
  dollarValuePerToken: '100',
  lastUpdatedAt: new Date().toUTCString(),
  source: WootzWallet.BlowfishAssetPriceSource.kCoingecko
}
...
export const BlowfishEVMAssets = {
  mainnetETH: {
    ...
    verified: true
  } as WootzWallet.BlowfishEVMAsset,
  sepoliaLink: {
  ...
  moonCat: {
    ...
    collection: 'MoonCat',
    price: {
      source: WootzWallet.BlowfishAssetPriceSource.kSimplehash,
      lastUpdatedAt: new Date().toUTCString(),
...
const sepoliaLinkTransferData: WootzWallet.BlowfishERC20TransferData = {
  counterparty: {
    address: '0xa92D461a9a988A7f11ec285d39783A637Fdd6ba4',
    kind: WootzWallet.BlowfishEVMAddressKind.kAccount
  },
  // send
  amount: {
...
const mockedSimulationWarnings: WootzWallet.BlowfishWarning[] = [
  {
    kind: WootzWallet.BlowfishWarningKind.kApprovalToEOA,
    message: 'APPROVAL_TO_E_O_A',
    severity: WootzWallet.BlowfishWarningSeverity.kCritical
  }
]

const emptyEvmRawInfo: WootzWallet.BlowfishEVMStateChangeRawInfoDataUnion = {
...
// EVM Events
export const mockedReceiveDaiEvent: WootzWallet.BlowfishEVMStateChange = {
  humanReadableDiff: 'Receive 1530.81307 DAI',
  rawInfo: {
    kind: WootzWallet.BlowfishEVMRawInfoKind.kErc20Transfer,
    data: {
      ...emptyEvmRawInfo,
      erc20TransferData: {
        amount: {
...
export const mockSendEthEvent: WootzWallet.BlowfishEVMStateChange = {
  humanReadableDiff: 'Send 1 ETH',
  rawInfo: {
    kind: WootzWallet.BlowfishEVMRawInfoKind.kNativeAssetTransfer,
    data: {
      ...emptyEvmRawInfo,
...
export const mockApproveUsdtEvent: WootzWallet.BlowfishEVMStateChange = {
  humanReadableDiff: 'Approve to transfer up to 1000 USDT',
  rawInfo: {
    kind: WootzWallet.BlowfishEVMRawInfoKind.kErc20Approval,
    data: {
      ...emptyEvmRawInfo,
      erc20ApprovalData: {
        amount: {
...
export const mockReceiveNftEvent: WootzWallet.BlowfishEVMStateChange = {
  ...
  rawInfo: {
    ...
    kind: WootzWallet.BlowfishEVMRawInfoKind.kErc721Transfer
  }
}

export const mockApproveBoredApeNftTransferEvent: //
WootzWallet.BlowfishEVMStateChange = {
  humanReadableDiff: 'Approve to transfer BoredApeYachtClub',
  rawInfo: {
    kind: WootzWallet.BlowfishEVMRawInfoKind.kErc721Approval,
    data: {
      ...emptyEvmRawInfo,
      erc721ApprovalData: {
        amount: {
...
WootzWallet.BlowfishEVMStateChange = {
  ...
  rawInfo: {
    kind: WootzWallet.BlowfishEVMRawInfoKind.kErc721ApprovalForAll,
    data: {
      ...emptyEvmRawInfo,
 ...
 */
export const mockEvmSimulatedResponse: WootzWallet.EVMSimulationResponse = {
  action: WootzWallet.BlowfishSuggestedAction.kNone,
  ...
  expectedStateChanges: [
    ...
    },
    {
      ...
      rawInfo: {
        kind: WootzWallet.BlowfishEVMRawInfoKind.kErc1155Transfer,
        data: {
          ...emptyEvmRawInfo,
          erc1155TransferData: {
            amount: {
 ...
 */
export const mockSimulatedSwapETHForDAI: WootzWallet.EVMSimulationResponse = {
  action: WootzWallet.BlowfishSuggestedAction.kNone,
  warnings: [],
  error: undefined,
 ...
 */
export const mockEvmSimulatedERC20Approval: WootzWallet.EVMSimulationResponse =
  {
    action: WootzWallet.BlowfishSuggestedAction.kNone,
    warnings: [],
    error: undefined,
 ...
 * - Send 3.181 ETH
 */
export const mockSimulatedBuyNFTWithETH: WootzWallet.EVMSimulationResponse = {
  action: WootzWallet.BlowfishSuggestedAction.kNone,
  warnings: [],
  error: undefined,
  expectedStateChanges: [
 ...
 */
export const mockSimulatedERC721Approve: WootzWallet.EVMSimulationResponse = {
  action: WootzWallet.BlowfishSuggestedAction.kNone,
  warnings: [],
  error: undefined,
 ...
 */
export const mockERC721ApproveForAllSim: WootzWallet.EVMSimulationResponse = {
  action: WootzWallet.BlowfishSuggestedAction.kWarn,
  warnings: [
    {
      kind: WootzWallet.BlowfishWarningKind.kUnlimitedAllowanceToNfts,
      message:
 ...
 * - Receive Corgi
 */
export const mockSimulatedBuyERC1155Token: WootzWallet.EVMSimulationResponse = {
  action: WootzWallet.BlowfishSuggestedAction.kNone,
  warnings: [],
  error: undefined,
  expectedStateChanges: [
 ...
 */
export const mockEvmERC1155ApproveForAll: WootzWallet.EVMSimulationResponse = {
  action: WootzWallet.BlowfishSuggestedAction.kNone,
  warnings: [
    {
      kind: WootzWallet.BlowfishWarningKind.kUnlimitedAllowanceToNfts,
  ...
  expectedStateChanges: [
    {
      ...
      rawInfo: {
        kind: WootzWallet.BlowfishEVMRawInfoKind.kErc1155ApprovalForAll,
        data: {
          ...emptyEvmRawInfo,
...
const BlowfishSolanaAssets = {
  ...
  } as WootzWallet.BlowfishSolanaAsset,
  bat: {
    decimals: mockSplBat.decimals,
    metaplexTokenStandard:
      WootzWallet.BlowfishMetaplexTokenStandardKind.kFungible,
  ...
  degenNft: {
    ...
    diff: {
      digits: BigInt(1),
      sign: WootzWallet.BlowfishDiffSign.kMinus
    },
    imageUrl: mockSplNft.logo,
    metaplexTokenStandard:
      WootzWallet.BlowfishMetaplexTokenStandardKind.kNonFungible,
...
const emptySvmRawInfo: WootzWallet.BlowfishSolanaStateChangeRawInfoDataUnion = {
...
const mockSendSolEvent: WootzWallet.BlowfishSolanaStateChange = {
  humanReadableDiff: 'Send 0.0005 SOL',
  suggestedColor: WootzWallet.BlowfishSuggestedColor.kCredit,
  rawInfo: {
    kind: WootzWallet.BlowfishSolanaRawInfoKind.kSolTransfer,
    data: {
      ...emptySvmRawInfo,
      solTransferData: {
...
const mockReceiveSolEvent: WootzWallet.BlowfishSolanaStateChange = {
  ...
  rawInfo: {
    ...
    data: {
      ...
      solTransferData: {
        ...
        diff: {
          digits: BigInt(500000),
          sign: WootzWallet.BlowfishDiffSign.kPlus
        }
      }
    }
  }
...
export const mockReceiveSolSimulation: WootzWallet.SolanaSimulationResponse = {
  action: WootzWallet.BlowfishSuggestedAction.kBlock,
  error: undefined,
...
export const mockNoChangeSolSimulation: WootzWallet.SolanaSimulationResponse = {
  action: WootzWallet.BlowfishSuggestedAction.kBlock,
  error: undefined,
  expectedStateChanges: [],
  warnings: []
...
export const mockSolStakingChangeEvent: WootzWallet.BlowfishSolanaStateChange =
  {
    humanReadableDiff: 'Re-stake 0.05657 SOL',
    suggestedColor: WootzWallet.BlowfishSuggestedColor.kCredit,
    rawInfo: {
      kind: WootzWallet.BlowfishSolanaRawInfoKind.kSolStakeAuthorityChange,
      data: {
        ...emptySvmRawInfo,
...
export const mockSendSplTokenEvent: WootzWallet.BlowfishSolanaStateChange = {
  humanReadableDiff: 'Send SPL BAT',
  suggestedColor: WootzWallet.BlowfishSuggestedColor.kDebit,
  rawInfo: {
    kind: WootzWallet.BlowfishSolanaRawInfoKind.kSplTransfer,
    data: {
      ...emptySvmRawInfo,
      splTransferData: {
...
export const mockSendSolNftEvent: WootzWallet.BlowfishSolanaStateChange = {
  humanReadableDiff: 'Send Wootz NFT',
  suggestedColor: WootzWallet.BlowfishSuggestedColor.kDebit,
  rawInfo: {
    kind: WootzWallet.BlowfishSolanaRawInfoKind.kSplTransfer,
    data: {
...
export const mockSvmSimulationResult: WootzWallet.SolanaSimulationResponse = {
  action: WootzWallet.BlowfishSuggestedAction.kNone,
  error: undefined,
  expectedStateChanges: [
    mockSendSolEvent,
...
export const mockOnRampCurrency: WootzWallet.OnRampCurrency = {
  currencyCode: 'USD',
  currencyName: 'United States Dollar',
  providers: []
}

export const mockOnRampCurrencies: WootzWallet.OnRampCurrency[] = [
  mockOnRampCurrency,
  {
    currencyCode: 'EUR',
    currencyName: 'Euro',
...
export const mockNativeBalanceRegistry: NativeAssetBalanceRegistry = {
  [mockAccount.address]: {
    [WootzWallet.BITCOIN_MAINNET]: '0',
    [WootzWallet.FILECOIN_ETHEREUM_MAINNET_CHAIN_ID]: '836',
    [WootzWallet.FILECOIN_MAINNET]: '0',
    [WootzWallet.MAINNET_CHAIN_ID]: '12312',
    [WootzWallet.SOLANA_MAINNET]: '0',
    // Secondary Networks
    [WootzWallet.ARBITRUM_MAINNET_CHAIN_ID]: '2322',
    [WootzWallet.ARBITRUM_NOVA_CHAIN_ID]: '45100002',
    [WootzWallet.AURORA_MAINNET_CHAIN_ID]: '4326',
    [WootzWallet.AVALANCHE_MAINNET_CHAIN_ID]: '345',
    [WootzWallet.BASE_MAINNET_CHAIN_ID]: '56453455',
    [WootzWallet.BNB_SMART_CHAIN_MAINNET_CHAIN_ID]: '444',
    [WootzWallet.CELO_MAINNET_CHAIN_ID]: '55851',
    [WootzWallet.FANTOM_MAINNET_CHAIN_ID]: '1',
    [WootzWallet.GNOSIS_CHAIN_ID]: '440502',
    [WootzWallet.NEON_EVM_MAINNET_CHAIN_ID]: '222',
    [WootzWallet.OPTIMISM_MAINNET_CHAIN_ID]: '567',
    [WootzWallet.POLYGON_MAINNET_CHAIN_ID]: '111',
    [WootzWallet.POLYGON_ZKEVM_CHAIN_ID]: '98094343',
    [WootzWallet.ZK_SYNC_ERA_CHAIN_ID]: '2621',
    // Test Networks
    [WootzWallet.FILECOIN_ETHEREUM_TESTNET_CHAIN_ID]: '0',
    [WootzWallet.LOCALHOST_CHAIN_ID]: '133',
    [WootzWallet.SEPOLIA_CHAIN_ID]: '7798',
    // Other
    [WootzWallet.GODWOKEN_CHAIN_ID]: '777',
    [WootzWallet.PALM_CHAIN_ID]: '2'
  },
  [mockEthAccountInfo.address]: {
    [WootzWallet.BITCOIN_MAINNET]: '0',
    [WootzWallet.FILECOIN_ETHEREUM_MAINNET_CHAIN_ID]: '22',
    [WootzWallet.FILECOIN_MAINNET]: '3111',
    [WootzWallet.MAINNET_CHAIN_ID]: '33214',
    [WootzWallet.SOLANA_MAINNET]: '0',
    // Secondary Networks
    [WootzWallet.ARBITRUM_MAINNET_CHAIN_ID]: '1221',
    [WootzWallet.ARBITRUM_NOVA_CHAIN_ID]: '251002',
    [WootzWallet.AURORA_MAINNET_CHAIN_ID]: '1111',
    [WootzWallet.AVALANCHE_MAINNET_CHAIN_ID]: '565',
    [WootzWallet.BASE_MAINNET_CHAIN_ID]: '4444',
    [WootzWallet.BNB_SMART_CHAIN_MAINNET_CHAIN_ID]: '2122',
    [WootzWallet.CELO_MAINNET_CHAIN_ID]: '1',
    [WootzWallet.FANTOM_MAINNET_CHAIN_ID]: '0',
    [WootzWallet.GNOSIS_CHAIN_ID]: '2',
    [WootzWallet.NEON_EVM_MAINNET_CHAIN_ID]: '0',
    [WootzWallet.OPTIMISM_MAINNET_CHAIN_ID]: '2',
    [WootzWallet.POLYGON_MAINNET_CHAIN_ID]: '55',
    [WootzWallet.POLYGON_ZKEVM_CHAIN_ID]: '666',
    [WootzWallet.ZK_SYNC_ERA_CHAIN_ID]: '5377',
    // Test Networks
    [WootzWallet.FILECOIN_ETHEREUM_TESTNET_CHAIN_ID]: '1',
    [WootzWallet.LOCALHOST_CHAIN_ID]: '3',
    [WootzWallet.SEPOLIA_CHAIN_ID]: '9',
    // Other
    [WootzWallet.GODWOKEN_CHAIN_ID]: '727',
    [WootzWallet.PALM_CHAIN_ID]: '1'
  },
  [mockSolanaAccount.address]: {
    [WootzWallet.SOLANA_MAINNET]: '7432'
  },
  [mockSolanaAccountInfo.address]: {
    [WootzWallet.SOLANA_MAINNET]: '45434545435'
  },
  [mockFilecoinAccount.address]: {
    [WootzWallet.FILECOIN_ETHEREUM_MAINNET_CHAIN_ID]: '34598722',
    [WootzWallet.FILECOIN_MAINNET]: '345545',
    [WootzWallet.MAINNET_CHAIN_ID]: '1000',
    // Secondary Networks
    [WootzWallet.ARBITRUM_MAINNET_CHAIN_ID]: '1000',
    [WootzWallet.ARBITRUM_NOVA_CHAIN_ID]: '3000',
    [WootzWallet.POLYGON_MAINNET_CHAIN_ID]: '330',
    // Test Networks
    [WootzWallet.FILECOIN_ETHEREUM_TESTNET_CHAIN_ID]: '220',
    [WootzWallet.LOCALHOST_CHAIN_ID]: '11110',
    [WootzWallet.SEPOLIA_CHAIN_ID]: '5550',
    // Other
    [WootzWallet.GODWOKEN_CHAIN_ID]: '40',
    [WootzWallet.PALM_CHAIN_ID]: '70'
  },
  [mockFilecoinAccountInfo.address]: {
    [WootzWallet.FILECOIN_ETHEREUM_MAINNET_CHAIN_ID]: '2334',
    [WootzWallet.FILECOIN_MAINNET]: '35',
    [WootzWallet.MAINNET_CHAIN_ID]: '220',
    // Secondary Networks
    [WootzWallet.ARBITRUM_MAINNET_CHAIN_ID]: '600',
    [WootzWallet.ARBITRUM_NOVA_CHAIN_ID]: '400',
    [WootzWallet.POLYGON_MAINNET_CHAIN_ID]: '30',
    // Test Networks
    [WootzWallet.FILECOIN_ETHEREUM_TESTNET_CHAIN_ID]: '20',
    [WootzWallet.LOCALHOST_CHAIN_ID]: '110',
    [WootzWallet.SEPOLIA_CHAIN_ID]: '50',
    // Other
    [WootzWallet.GODWOKEN_CHAIN_ID]: '4',
    [WootzWallet.PALM_CHAIN_ID]: '7'
  }
}
