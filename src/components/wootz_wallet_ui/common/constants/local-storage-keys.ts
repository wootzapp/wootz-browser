...
export const LOCAL_STORAGE_KEYS = {
  IS_PORTFOLIO_OVERVIEW_GRAPH_HIDDEN:
    'WOOTZ_WALLET_IS_WALLET_PORTFOLIO_OVERVIEW_GRAPH_HIDDEN',
  HIDE_PORTFOLIO_BALANCES: 'WOOTZ_WALLET_HIDE_PORTFOLIO_BALANCES',
  HIDE_PORTFOLIO_NFTS_TAB: 'WOOTZ_WALLET_HIDE_PORTFOLIO_NFTS_TAB',
  ...
  IS_ENABLE_NFT_AUTO_DISCOVERY_MODAL_HIDDEN:
    'WOOTZ_WALLET_IS_ENABLE_NFT_AUTO_DISCOVERY_MODAL_HIDDEN',
  DEBUG: 'WOOTZ_WALLET_DEBUG',
  FILTERED_OUT_PORTFOLIO_NETWORK_KEYS:
    'WOOTZ_WALLET_FILTERED_OUT_PORTFOLIO_NETWORK_KEYS',
  FILTERED_OUT_PORTFOLIO_ACCOUNT_IDS:
    'WOOTZ_WALLET_FILTERED_OUT_PORTFOLIO_ACCOUNT_IDS',
  HIDE_PORTFOLIO_SMALL_BALANCES: 'WOOTZ_WALLET_HIDE_PORTFOLIO_SMALL_BALANCES',
  GROUP_PORTFOLIO_ASSETS_BY: 'WOOTZ_WALLET_GROUP_PORTFOLIO_ASSETS_BY',
  SHOW_NETWORK_LOGO_ON_NFTS: 'WOOTZ_WALLET_SHOW_NETWORK_LOGO_ON_NFTS',
  COLLAPSED_PORTFOLIO_ACCOUNT_IDS:
    'WOOTZ_WALLET_COLLAPSED_PORTFOLIO_ACCOUNTS_IDS',
  COLLAPSED_PORTFOLIO_NETWORK_KEYS:
    'WOOTZ_WALLET_COLLAPSED_PORTFOLIO_NETWORK_KEYS',
  CURRENT_PANEL: 'WOOTZ_WALLET_CURRENT_PANEL',
  LAST_VISITED_PANEL: 'WOOTZ_WALLET_LAST_VISITED_PANEL',
  TOKEN_BALANCES: 'WOOTZ_WALLET_TOKEN_BALANCES4',
  SPAM_TOKEN_BALANCES: 'SPAM_TOKEN_BALANCES3',
  SAVED_SESSION_ROUTE: 'WOOTZ_WALLET_SAVED_SESSION_ROUTE',
  USER_HIDDEN_TOKEN_IDS: 'WOOTZ_WALLET_USER_HIDDEN_TOKEN_IDS2',
  USER_DELETED_TOKEN_IDS: 'WOOTZ_WALLET_USER_DELETED_TOKEN_IDS2',
  ...
  FILTERED_OUT_DAPP_NETWORK_KEYS: 'WOOTZ_WALLET_FILTERED_OUT_DAPP_NETWORK_KEYS',
  FILTERED_OUT_DAPP_CATEGORIES: 'WOOTZ_WALLET_FILTERED_OUT_DAPP_CATEGORIES'
} as const
...
const LOCAL_STORAGE_KEYS_DEPRECATED = {
  ...
  SESSION_ROUTE: 'WOOTZ_WALLET_SESSION_ROUTE',
  FILTERED_OUT_PORTFOLIO_ACCOUNT_ADDRESSES:
    'WOOTZ_WALLET_FILTERED_OUT_PORTFOLIO_ACCOUNT_ADDRESSES',
  COLLAPSED_PORTFOLIO_ACCOUNT_ADDRESSES:
    'WOOTZ_WALLET_COLLAPSED_PORTFOLIO_ACCOUNTS_ADDRESSES',
  TOKEN_BALANCES: 'WOOTZ_WALLET_TOKEN_BALANCES',
  TOKEN_BALANCES2: 'WOOTZ_WALLET_TOKEN_BALANCES2',
  TOKEN_BALANCES3: 'WOOTZ_WALLET_TOKEN_BALANCES3',
  SPAM_TOKEN_BALANCES: 'SPAM_TOKEN_BALANCES',
  SPAM_TOKEN_BALANCES2: 'SPAM_TOKEN_BALANCES2',
  USER_REMOVED_NON_FUNGIBLE_TOKEN_IDS:
    'WOOTZ_WALLET_USER_REMOVED_NON_FUNGIBLE_TOKEN_IDS',
  USER_DELETED_NON_FUNGIBLE_TOKEN_IDS:
    'WOOTZ_WALLET_USER_DELETED_NON_FUNGIBLE_TOKEN_IDS',
  USER_REMOVED_FUNGIBLE_TOKEN_IDS:
    'WOOTZ_WALLET_USER_REMOVED_FUNGIBLE_TOKEN_IDS',
  USER_DELETED_TOKEN_IDS: 'WOOTZ_WALLET_USER_DELETED_TOKEN_IDS',
  USER_HIDDEN_TOKEN_IDS: 'WOOTZ_WALLET_USER_HIDDEN_TOKEN_IDS',
  NFT_COLLECTION_NAMES_REGISTRY: 'NFT_COLLECTION_NAMES_REGISTRY',
  IS_IPFS_BANNER_HIDDEN: 'WOOTZ_WALLET_IS_IPFS_BANNER_HIDDEN'
}
