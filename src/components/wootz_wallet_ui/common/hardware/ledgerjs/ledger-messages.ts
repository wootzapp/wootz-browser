...
const wootzWalletLedgerBridgeUrl = loadTimeData.getString(
  'wootzWalletLedgerBridgeUrl'
)
export const LEDGER_BRIDGE_URL =
  wootzWalletLedgerBridgeUrl.charAt(wootzWalletLedgerBridgeUrl.length - 1) ===
  '/'
    ? wootzWalletLedgerBridgeUrl.slice(0, -1) // Strip off trailing '/' in URL
    : wootzWalletLedgerBridgeUrl
