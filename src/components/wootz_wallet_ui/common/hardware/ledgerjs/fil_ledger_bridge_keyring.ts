...
import { WootzWallet, FilecoinNetwork } from '../../../constants/types'
  ...
  implements LedgerFilecoinKeyring
{
  ...
  keyringId = (network: FilecoinNetwork): WootzWallet.KeyringId => {
    return network === WootzWallet.FILECOIN_MAINNET
