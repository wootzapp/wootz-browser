...
> & {
  ...
  idsByCoinType: Record<WootzWallet.CoinType, EntityId[]>
  visibleTokenIds: string[]
  hiddenTokenIds: string[]
  deletedTokenIds: string[]
  visibleTokenIdsByChainId: Record<string, string[]>
  visibleTokenIdsByCoinType: Record<WootzWallet.CoinType, EntityId[]>
  hiddenTokenIdsByChainId: Record<string, string[]>
  hiddenTokenIdsByCoinType: Record<WootzWallet.CoinType, EntityId[]>

  // fungible tokens
  fungibleIdsByChainId: Record<EntityId, EntityId[]>
  fungibleIdsByCoinType: Record<WootzWallet.CoinType, EntityId[]>
  ...
  fungibleVisibleTokenIdsByCoinType: Record<WootzWallet.CoinType, EntityId[]>
  fungibleHiddenTokenIdsByChainId: Record<string, string[]>
  fungibleHiddenTokenIdsByCoinType: Record<WootzWallet.CoinType, EntityId[]>

  // non-fungible tokens
  nonFungibleIdsByChainId: Record<EntityId, EntityId[]>
  nonFungibleIdsByCoinType: Record<WootzWallet.CoinType, EntityId[]>
  ...
  nonFungibleVisibleTokenIdsByCoinType: Record<WootzWallet.CoinType, EntityId[]>
  nonFungibleHiddenTokenIdsByChainId: Record<string, string[]>
  nonFungibleHiddenTokenIdsByCoinType: Record<WootzWallet.CoinType, EntityId[]>
...
export const selectCombinedTokensList = createDraftSafeSelector(
  // inputs
  [
    (knownTokens: WootzWallet.BlockchainToken[]) => knownTokens,
    (_, userTokens: WootzWallet.BlockchainToken[]) => userTokens
  ],
  // output
