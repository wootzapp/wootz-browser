...
export type AccountInfoEntity = WootzWallet.AccountInfo

export const accountInfoEntityAdaptor: EntityAdapter<AccountInfoEntity> = {
  ...createEntityAdapter<AccountInfoEntity>({
    selectId: (model: Pick<WootzWallet.AccountInfo, 'accountId'>): EntityId => {
...
type MakeSelectNetworkByIdFromQuery =
  EntityByIdFromRegistryResultSelectorFactory<WootzWallet.NetworkInfo>
