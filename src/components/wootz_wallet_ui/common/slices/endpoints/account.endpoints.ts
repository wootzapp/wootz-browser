...
export const accountEndpoints = ({
  ...
  return {
    ...
    setSelectedAccount: mutation<WootzWallet.AccountId, WootzWallet.AccountId>({
    ...
    getSelectedAccountId: query<WootzWallet.AccountId | null, void>({
    ...
    importHardwareAccounts: mutation<true, WootzWallet.HardwareWalletAccount[]>(
      {
        queryFn: async (
          hardwareAccounts,
          { endpoint },
