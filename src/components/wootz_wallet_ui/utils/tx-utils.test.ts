...
import { WootzWallet, SerializableTransactionInfo } from '../constants/types'
    ...
    const { buyAmountWei, sellAmountWei, buyToken, sellToken } =
      getETHSwapTransactionBuyAndSellTokens({
        ...
        tx: {
          ...
          txType: WootzWallet.TransactionType.ETHSwap,
          isRetriable: false,
          swapInfo: {
...
describe('check for insufficient funds errors', () => {
  describe.each([
    ['ERC20Transfer', WootzWallet.TransactionType.ERC20Transfer],
    ['ERC20Approve', WootzWallet.TransactionType.ERC20Approve],
    ['ERC721TransferFrom', WootzWallet.TransactionType.ERC721TransferFrom],
    [
      'ERC721SafeTransferFrom',
      WootzWallet.TransactionType.ERC721SafeTransferFrom
    ],
    ['ETHSend', WootzWallet.TransactionType.ETHSend],
    ['Other', WootzWallet.TransactionType.Other]
  ])('%s', (_, txType) => {
    ...
    it('should be false when funds are sufficient for gas', () => {
      ...
      const mockTxData: WootzWallet.TxData1559 =
      ...
      const mockTransactionInfo = {
        ...
        txArgs: [
          WootzWallet.TransactionType.ERC20Approve,
          WootzWallet.TransactionType.ERC20Transfer
        ].includes(txType)
          ? ['mockRecipient', '0x0']
  ...
  describe('ERC20Transfer', () => {
    it('should be true when funds are insufficient for send amount', () => {
      ...
      const transactionInfo: SerializableTransactionInfo = {
        ...
        txType: WootzWallet.TransactionType.ERC20Transfer,
        txDataUnion: {
          ethTxData: {} as any,
          filTxData: undefined,
          solanaTxData: undefined,
...
describe('getIsRevokeApprovalTx', () => {
  test('correctly detects revocations', () => {
    expect(
      getIsRevokeApprovalTx({
        ...mockTransactionInfo,
        txType: WootzWallet.TransactionType.ERC20Approve,
        txArgs: [
      ...
      expect(
        findTransactionToken(
          createMockTransactionInfo({
            ...
            coinType: WootzWallet.CoinType.SOL,
