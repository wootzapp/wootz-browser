...
describe('getNetworkInfo', () => {
  ...
  it('should return network object with default values if network with chainId is not found', () => {
    ...
    const coin = WootzWallet.CoinType.ETH
...
describe('filterNetworksForAccount', () => {
  it('CoinType ETH, should return all ETH networks', () => {
    ...
    ).toEqual(mockNetworks.filter((n) => n.coin === WootzWallet.CoinType.ETH))
  })
...
describe('getCoinFromTxDataUnion', () => {
  it('Filecoin transaction', () => {
    expect(
      getCoinFromTxDataUnion({
        filTxData: {} as WootzWallet.FilTxData,
        ethTxData: undefined,
        ethTxData1559: undefined,
        solanaTxData: undefined,
        btcTxData: undefined
      })
    ).toEqual(WootzWallet.CoinType.FIL)
  })
  it('Ethereum transaction', () => {
    expect(
      getCoinFromTxDataUnion({
        filTxData: undefined,
        ethTxData: {} as WootzWallet.TxData,
        ethTxData1559: undefined,
        solanaTxData: undefined,
        btcTxData: undefined
      })
    ).toEqual(WootzWallet.CoinType.ETH)
  })
  it('Ethereum1559 transaction', () => {
    expect(
      getCoinFromTxDataUnion({
        filTxData: undefined,
        ethTxData: undefined,
        ethTxData1559: {} as WootzWallet.TxData1559,
        solanaTxData: undefined,
        btcTxData: undefined
      })
    ).toEqual(WootzWallet.CoinType.ETH)
  ...
  it('Solana transaction', () => {
    expect(
      getCoinFromTxDataUnion({
        ...
        ethTxData: undefined,
        ethTxData1559: undefined,
        solanaTxData: {} as WootzWallet.SolanaTxData,
        btcTxData: undefined
      })
    ).toEqual(WootzWallet.CoinType.SOL)
  })
  it('Bitcoin transaction', () => {
    expect(
      getCoinFromTxDataUnion({
        ...
        ethTxData1559: undefined,
        solanaTxData: undefined,
        btcTxData: {} as WootzWallet.BtcTxData
      })
    ).toEqual(WootzWallet.CoinType.BTC)
  })
})
