...
const createMockRegistry = (balance: string) => {
  ...
  setBalance({
    accountId: mockEthAccountInfo.accountId,
    chainId: WootzWallet.POLYGON_MAINNET_CHAIN_ID,
    contractAddress: '',
    balance,
    tokenBalancesRegistry,
    coinType: WootzWallet.CoinType.ETH,
  ...
  setBalance({
    ...
    balance,
    tokenBalancesRegistry,
    coinType: WootzWallet.CoinType.BTC,
    tokenId: ''
  })
  ...
  setBalance({
    ...
    balance,
    tokenBalancesRegistry,
    coinType: WootzWallet.CoinType.ZEC,
    tokenId: ''
  })
...
describe('getActiveWalletCount', () => {
  ...
  it('should return no active accounts when zero balance', () => {
    ...
    expect(
      ...
      [WootzWallet.CoinType.BTC]: 0,
      [WootzWallet.CoinType.ETH]: 0,
      [WootzWallet.CoinType.FIL]: 0,
      [WootzWallet.CoinType.ZEC]: 0,
      [WootzWallet.CoinType.SOL]: 0
    })
  })
  ...
  it('should include testnets with flag', () => {
    ...
    expect(
      ...
      [WootzWallet.CoinType.ETH]: 1,
      [WootzWallet.CoinType.SOL]: 0,
      [WootzWallet.CoinType.FIL]: 0,
      [WootzWallet.CoinType.ZEC]: 0,
      [WootzWallet.CoinType.BTC]: 1
    })
  })
  ...
  it('should report active accounts', () => {
    ...
    expect(getActiveWalletCount(mockAccountIds, registry, true)).toStrictEqual({
      [WootzWallet.CoinType.ETH]: 1,
      [WootzWallet.CoinType.SOL]: 1,
      [WootzWallet.CoinType.FIL]: 1,
      [WootzWallet.CoinType.ZEC]: 1,
      [WootzWallet.CoinType.BTC]: 2 // mainnet and testnet accounts
    })
  })
  ...
  it('should report many active accounts', () => {
    ...
    expect(
      ...
      [WootzWallet.CoinType.ETH]: 2,
      [WootzWallet.CoinType.SOL]: 1,
      [WootzWallet.CoinType.FIL]: 1,
      [WootzWallet.CoinType.ZEC]: 2,
      [WootzWallet.CoinType.BTC]: 2
    })
  })
})
