...
import {
  makeWootzWalletServiceObserver,
...
import { resetRewardsProxy } from '../common/async/wootz_rewards_api_proxy'
import {
  WootzRewardsProxyOverrides,
...
export const createMockStore = (
  ...
  rewardsApiOverrides?: WootzRewardsProxyOverrides
) => {
  // api reset
  ...
  proxy?.addWootzWalletServiceObserver?.(makeWootzWalletServiceObserver(store))
