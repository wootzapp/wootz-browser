...
export function toByteArrayStringUnion<
  D extends keyof WootzWallet.ByteArrayStringUnion
>(unionItem: Pick<WootzWallet.ByteArrayStringUnion, D>) {
  return Object.assign({}, unionItem) as WootzWallet.ByteArrayStringUnion
}
