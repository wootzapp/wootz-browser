...
const mockHardwareAccounts: WootzWallet.AccountInfo[] = [
  {
    ...mockAccount,
    accountId: {
      ...mockAccount.accountId,
      kind: WootzWallet.AccountKind.kHardware
    },
...
const mockFilecoinMainnetAccount: WootzWallet.AccountInfo = {
  ...mockFilecoinAccount,
  accountId: {
    ...mockFilecoinAccount.accountId,
    keyringId: WootzWallet.KeyringId.kFilecoin
  }
}
...
describe('Test getAccountTypeDescription', () => {
  ...
  test('BTC Testnet Account Description', () => {
    ...
    ).toEqual('wootzWalletBTCTestnetAccountDescription')
  })
})
