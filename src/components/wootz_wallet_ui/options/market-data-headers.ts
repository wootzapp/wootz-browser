...
export const marketGridHeaders: MarketGridHeader[] = [
  {
    id: 'assets',
    label: getLocale('wootzWalletMarketDataAssetsColumn')
  },
  {
    id: 'currentPrice',
    label: getLocale('wootzWalletMarketDataPriceColumn'),
    sortable: true
  },
  {
    id: 'priceChangePercentage24h',
    label: getLocale('wootzWalletMarketData24HrColumn'),
    sortable: true,
    width: '80px'
  },
  {
    id: 'marketCap',
    label: getLocale('wootzWalletMarketDataMarketCapColumn'),
    sortable: true,
    width: '90px',
    hideOnPanel: true
  },
  {
    id: 'totalVolume',
    label: getLocale('wootzWalletMarketDataVolumeColumn'),
    sortable: true,
    hideOnPanel: true,
    width: '95px'
  },
