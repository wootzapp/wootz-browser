...
export const mockMoonCatNFT: WootzWallet.BlockchainToken = {
...
export const mockERC20Token: WootzWallet.BlockchainToken = {
...
export const mockErc721Token: WootzWallet.BlockchainToken = {
...
export const mockSplNft: WootzWallet.BlockchainToken = {
  ...
  isErc721: false,
  isErc1155: false,
  splTokenProgram: WootzWallet.SPLTokenProgram.kToken,
  isNft: true,
  isSpam: false,
  decimals: 1,
  visible: true,
...
export const mockAccountAssetOptions: WootzWallet.BlockchainToken[] = [
  mockEthToken,
  mockSolToken,
  mockFilToken,
  mockBasicAttentionToken,
...
export const mockNewAssetOptions: WootzWallet.BlockchainToken[] = [
  mockEthToken,
  {
    contractAddress: '2',
    name: 'Basic Attention Token',
