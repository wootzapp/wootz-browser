...
export const mockSolanaTransactionInfo: SerializableTransactionInfo = {
  ...
  txDataUnion: {
    ...
    solanaTxData: {
      ...
      txType: WootzWallet.TransactionType.SolanaSPLTokenTransfer,
      version: 1
    },
    filTxData: undefined,
    btcTxData: undefined,
...
export const mockSolanaTransactionInfoAccount: WootzWallet.AccountInfo = {
  ...mockSolanaAccount,
  address: mockSolanaTransactionInfo.fromAddress || '',
  accountId: mockSolanaTransactionInfo.fromAccountId
}

export const mockSvmTxInfos: WootzWallet.TransactionInfo[] = [
  deserializeTransaction({
    ...mockSolanaTransactionInfo,
    fromAddress: mockSolanaTransactionInfoAccount.address,
    txStatus: WootzWallet.TransactionStatus.Unapproved,
    txType: WootzWallet.TransactionType.SolanaSystemTransfer
  }),
  deserializeTransaction({
    ...mockSolanaTransactionInfo,
    fromAddress: mockSolanaTransactionInfoAccount.address,
...
export const mockFilSendTransaction: FileCoinTransactionInfo = {
  ...
  txHash: 'fil-send-tx',
  txParams: [],
  txStatus: WootzWallet.TransactionStatus.Confirmed,
...
export const createMockTransactionInfo = (arg: {
  ...
  const txBase =
    coinType === WootzWallet.CoinType.FIL
