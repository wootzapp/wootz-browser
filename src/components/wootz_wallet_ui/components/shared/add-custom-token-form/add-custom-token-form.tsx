...
export const AddCustomTokenForm = (props: Props) => {
  ...
  const tokenInfo: WootzWallet.BlockchainToken | undefined =
    React.useMemo(() => {
      ...
      return {
        ...
        tokenId: '',
        isCompressed: false,
        isErc20: customAssetsNetwork.coin !== WootzWallet.CoinType.SOL,
        isErc721: false,
        isErc1155: false,
  ...
  const tokenContractAddressError =
    ...
    (tokenInfo?.coin !== WootzWallet.CoinType.SOL &&
  ...
  const formErrors = React.useMemo(() => {
    return [
      ...
      tokenDecimalsError && getLocale('wootzWalletTokenDecimalsIsRequiredError')
    ]
  }, [
    customAssetsNetworkError,
    tokenNameError,
    ...
    <>
      <FormWrapper onClick={onHideNetworkDropDown}>
        ...
        >
          <DividerRow>
            <AdvancedButton onClick={onToggleShowAdvancedFields}>
              <DividerText>
                {getLocale('wootzWalletWatchListAdvanced')}
              </DividerText>
            </AdvancedButton>
            <AdvancedButton onClick={onToggleShowAdvancedFields}>
          ...
          {showAdvancedFields && (
            <FullWidthFormColumn>
              ...
              >
                <InputLabel>{getLocale('wootzWalletIconURL')}</InputLabel>
              </Input>
              ...
              >
                <InputLabel>
                  {getLocale('wootzWalletWatchListCoingeckoId')}
                </InputLabel>
              </Input>
            </FullWidthFormColumn>
          )}
        ...
        {tokenAlreadyExists && !selectedAsset && (
          <ErrorText>
            {getLocale('wootzWalletCustomTokenExistsError')}
          </ErrorText>
        )}
      </FormWrapper>
