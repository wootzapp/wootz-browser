    ...
    <>
      ...
      >
        ...
        <TitleText textSize='22px'>
          {getLocale('wootzWalletChangeAccount')}
        </TitleText>
      </Row>
      ...
      <ScrollableColumn>
        {connectedAccounts.length !== 0 && (
          <>
            ...
            {connectedAccounts.map((account: WootzWallet.AccountInfo) => (
              <ChangeAccountButton
          ...
          <>
            <Row justifyContent='flex-start'>
              <DescriptionText
                ...
                isBold={true}
              >
                {getLocale('wootzWalletAvailableAccounts')}
              </DescriptionText>
            </Row>

            {availableAccounts.map((account: WootzWallet.AccountInfo) => (
              <ChangeAccountButton
                key={account.accountId.uniqueKey}
                account={account}
                getAccountsFiatValue={getAccountsFiatValue}
