...
interface Props {
  ...
  getAccountsFiatValue: (account: WootzWallet.AccountInfo) => Amount
}
...
export const ChangeAccountButton = (props: Props) => {
  ...
  const buttonText = React.useMemo((): string => {
    const connectText =
      selectedCoin === WootzWallet.CoinType.SOL
        ? getLocale('wootzWalletSitePermissionsTrust')
        : getLocale('wootzWalletAddAccountConnect')
    const disconnectText =
      selectedCoin === WootzWallet.CoinType.SOL
        ? getLocale('wootzWalletSitePermissionsRevoke')
        : getLocale('wootzWalletSitePermissionsDisconnect')
    return hasPermission
      ? isActive
        ? disconnectText
        : getLocale('wootzWalletSitePermissionsSwitch')
      : connectText
  ...
  const onClickConnect = React.useCallback(async () => {
    ...
    if (selectedCoin !== WootzWallet.CoinType.SOL) {
