...
import { WootzWallet, DAppSupportedCoinTypes } from '../../../constants/types'
...
export const DAppConnectionMain = (props: Props) => {
  ...
  const connectionStatusText = React.useMemo((): string => {
    if (isPermissionDenied) {
      return getLocale('wootzWalletPanelBlocked')
    }
    return isConnected
      ? getLocale('wootzWalletPanelConnected')
      : getLocale('wootzWalletNotConnected')
