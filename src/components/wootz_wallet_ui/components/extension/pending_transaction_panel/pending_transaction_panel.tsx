...
const SIMPLE_TRANSACTION_TYPES = [
  ...
  WootzWallet.TransactionType.ETHSwap // use safer-sign UI
]
...
export const PendingTransactionPanel: React.FC<Props> = ({
  ...
  const isSimulationPermitted =
    ...
    txSimulationOptIn === WootzWallet.BlowfishOptInStatus.kAllowed
  ...
  if (
    networkHasTxSimulationSupport &&
    txSimulationOptIn === WootzWallet.BlowfishOptInStatus.kUnset &&
    selectedPendingTransaction.txType !== WootzWallet.TransactionType.ETHSwap
  ) {
