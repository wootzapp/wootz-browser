...
export const TransactionSubmittedOrSigned = (props: Props) => {
  ...
  const title =
    transaction.txStatus === WootzWallet.TransactionStatus.Submitted
      ? getLocale('wootzWalletTransactionSubmittedTitle')
      : getLocale('wootzWalletTransactionSignedTitle')
  const description =
    transaction.txStatus === WootzWallet.TransactionStatus.Submitted
      ? getLocale('wootzWalletTransactionSubmittedDescription')
      : getLocale('wootzWalletTransactionSignedDescription')
  ...
  return (
    ...
    >
      ...
      <ButtonRow>
        ...
        >
          {getLocale('wootzWalletTransactionExplorer')}
        </DetailButton>
        <LinkIcon />
      </ButtonRow>
    </Panel>
