...
interface Props {
  ...
  accountsToConnect: WootzWallet.AccountInfo[]
}
...
export const ConnectWithSite = (props: Props) => {
  ...
  const [selectedDuration, setSelectedDuration] =
    React.useState<WootzWallet.PermissionLifetimeOption>(
      WootzWallet.PermissionLifetimeOption.kPageClosed
    )
  ...
  return (
    <StyledWrapper>
      ...
      >
        {!isReadyToConnect && (
          <>
            <SelectAddressContainer>
              ...
              >
                ...
                >
                  <Row justifyContent='flex-start'>
                    ...
                    <AddAccountText>
                      {getLocale('wootzWalletAddAccount')}
                    </AddAccountText>
                  </Row>
              ...
              >
                <AccountNameText>
                  {getLocale('wootzWalletConnectWithSite')}
                </AccountNameText>
              </Row>
        ...
        {isReadyToConnect && (
          ...
          >
            ...
            >
              <SectionLabel>
                {getLocale('wootzWalletPermissionDuration')}
              </SectionLabel>
              {isPrivateWindow ? (
                <DurationLabel>
                  {getLocale('wootzWalletPermissionUntilClose')}
                </DurationLabel>
              ) : (
              ...
              <SectionLabel>
                {getLocale('wootzWalletConnectPermittedLabel')}
              </SectionLabel>
              ...
              <SectionLabel>
                {getLocale('wootzWalletConnectNotPermittedLabel')}
              </SectionLabel>
      ...
      >
        ...
        >
          {isReadyToConnect
            ? getLocale('wootzWalletAddAccountConnect')
            : getLocale('wootzWalletConnectWithSiteNext')}
        </NavButton>
      </ButtonRow>
    </StyledWrapper>
  )
