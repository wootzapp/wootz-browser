...
const getFormattedKeyValue = (key: string, data?: WootzWallet.SIWEMessage) => {
  if (!data?.[key]) {
    return ''
  }
...
interface Props {
  data: WootzWallet.SignMessageRequest
  onSignIn: () => void
  onCancel: () => void
}
        ...
        <>
          ...
          >
            <Title
              ...
              textSize='18px'
            >
              {getLocale('wootzWalletSeeDetails')}
            </Title>
  ...
  return (
    <StyledWrapper>
      <>
        <Row padding='16px 16px 11px 16px'>
          <Title
            ...
            textSize='18px'
          >
            {getLocale('wootzWalletSignInWithWootzWallet')}
          </Title>
        </Row>
        <VerticalDivider />
      </>
        ...
        <MessageBox>
          ...
          >
            <MessageText
              ...
              isBold={false}
            >
              {getLocale('wootzWalletSignInWithWootzWalletMessage').replaceAll(
                '$1',
                data.originInfo.eTldPlusOne
              )}
            </MessageText>
          ...
          {hasMessageAndResource && (
            ...
            >
              ...
              <Title
                ...
                textSize='14px'
              >
                {getLocale('wootzWalletResources')}:
              </Title>
              <VerticalSpace space='4px' />
      ...
      <Row padding='16px'>
        ...
        <Button onClick={onSignIn}>{getLocale('wootzWalletSignIn')}</Button>
      </Row>
    </StyledWrapper>
  )
}
