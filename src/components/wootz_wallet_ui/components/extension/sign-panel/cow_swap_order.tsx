...
export function SignCowSwapOrder(props: Props) {
  ...
  return (
    <StyledWrapper>
      ...
      <HeaderTitle>{getLocale('wootzWalletSwapReviewHeader')}</HeaderTitle>
      ...
      <NetworkFeeAndDetailsContainer>
        <NetworkFeeContainer>
          <NetworkFeeTitle>
            {getLocale('wootzWalletNetworkFees')}
          </NetworkFeeTitle>
          <NetworkFeeValue>
            <CreateNetworkIcon
              network={network}
        ...
        <TextButton onClick={() => setShowDetails(!showDetails)}>
          {showDetails
            ? getLocale('wootzWalletSignTransactionEIP712MessageHideDetails')
      ...
      <SignPanelButtonRow>
        ...
        <NavButton
          buttonType='sign'
          text={getLocale('wootzWalletSignTransactionButton')}
          onSubmit={onSignIn}
          disabled={isDisabled}
        />
      </SignPanelButtonRow>
