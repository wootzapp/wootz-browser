...
import { WootzWallet, Url } from '../../../constants/types'
...
const signMessageData: WootzWallet.SignMessageRequest = {
  id: 0,
  ...
  signData: {
    ...
    ethSiweData: {
      ...
      statement: 'I accept the Wootz Terms of Service: http://address.com/tos',
      uri: {
...
export const _SignData = {
  render: () => {
    const signMessageDataPayload: WootzWallet.SignMessageRequest[] = [
      {
        id: 0,
        accountId: {
          coin: WootzWallet.CoinType.ETH,
