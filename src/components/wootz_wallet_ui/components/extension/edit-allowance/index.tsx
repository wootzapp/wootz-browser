...
import Radio from 'wootz-ui/components/formControls/radio'
...
export const EditAllowance = (props: Props) => {
  ...
  return (
    <Panel
      navAction={onCancel}
      title={getLocale('wootzWalletEditPermissionsTitle')}
    >
      <StyledWrapper>
        <Description>
          {getLocale('wootzWalletEditPermissionsDescription').replace(
            '$1',
            approvalTarget
          )}
        </Description>
        <FormColumn>
          ...
          >
            <div data-value='proposed'>
              <AllowanceOption>
                <AllowanceTitle>
                  {getLocale('wootzWalletEditPermissionsProposedAllowance')}
                </AllowanceTitle>
                <AllowanceContent>
            ...
            <div data-value='custom'>
              <AllowanceOption>
                <AllowanceTitle>
                  {getLocale('wootzWalletEditPermissionsCustomAllowance')}
                </AllowanceTitle>
                <Input
