    ...
    <FullWidth>
      ...
      >
        ...
        <Row justifyContent='space-between'>
          {retrySimulation ? (
            <AlertTitle isInfo>
              {getLocale('wootzWalletTransactionPreviewFailed')}{' '}
              <Button
                kind='plain'
                onClick={retrySimulation}
              >
                <u>{getLocale('wootzWalletButtonRetry')}</u>
              </Button>
            </AlertTitle>
          ) : (
...
export function TransactionWarnings({
  ...
  warnings: Array<Pick<WootzWallet.BlowfishWarning, 'message' | 'severity'>>
  ...
  const hasCriticalWarnings = warnings.some(
    (warning) =>
      warning.severity === WootzWallet.BlowfishWarningSeverity.kCritical
  )
    ...
    <FullWidth>
      ...
      >
        ...
        >
          {getLocale(
            classifyAs === 'risks'
              ? 'wootzWalletFoundRisks'
              : 'wootzWalletFoundIssues'
          ...
          {onDismiss && (
            ...
            >
              <DismissButton
                ...
                onClick={onDismiss}
              >
                {getLocale('wootzWalletDismissButton')}
              </DismissButton>
            </Row>
          )}
        </div>
