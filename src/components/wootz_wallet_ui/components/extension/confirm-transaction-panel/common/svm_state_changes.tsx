...
const METAPLEX_NFT_KINDS = [
  ...
  WootzWallet.BlowfishMetaplexTokenStandardKind.kNonFungibleEdition
] as const
...
export const SOLTransfer = ({
  ...
  transfer: WootzWallet.BlowfishSOLTransferData
  ...
  // computed
  const isReceive = transfer.diff.sign !== WootzWallet.BlowfishDiffSign.kMinus
...
export const SPLTokenTransfer = ({
  ...
  transfer: WootzWallet.BlowfishSPLTransferData
  ...
  return (
    ...
    >
      ...
      <Row
        ...
        title={
          isVerified
            ? getLocale('wootzWalletTokenIsVerifiedByLists').replace('$1', '1')
            : getLocale('wootzWalletTokenIsUnverified')
        }
      >
        <IconsWrapper marginRight='0px'>
          {asset.isNft ? (
...
export const SPLTokenApproval = ({
  ...
  approval: WootzWallet.BlowfishSPLApprovalData
  network: BlockchainInfo
}): JSX.Element => {
  // computed
  const isNft =
...
export const SolStakingAuthChange = ({
  ...
  authChange: WootzWallet.BlowfishSOLStakeAuthorityChangeData
  network: BlockchainInfo
}) => {
  // computed from props
    ...
    >
      {hasStakerChange ? (
        ...
        >
          <Row
            ...
            justifyContent='flex-start'
          >
            <StateChangeText>{getLocale('wootzWalletStaker')}</StateChangeText>
          </Row>
          <AddressChange
      ...
      {hasWithdrawerChange ? (
        ...
        >
          ...
          >
            <StateChangeText>
              {getLocale('wootzWalletWithdrawer')}
            </StateChangeText>
          </Row>
          <AddressChange
...
export const SolAccountOwnershipChange = ({
  ...
  ownerChange: WootzWallet.BlowfishSolanaUserAccountOwnerChangeData
  network: BlockchainInfo
}) => {
  // render
  return (
    ...
    >
      <Row
        ...
        justifyContent='flex-start'
      >
        <StateChangeText>{getLocale('wootzWalletOwner')}</StateChangeText>
      </Row>
      <AddressChange
...
export function getComponentForSvmTransfer(
  transfer: WootzWallet.BlowfishSolanaStateChange,
  network: ChainInfo,
  transactionDetails?: ParsedTransaction
) {
