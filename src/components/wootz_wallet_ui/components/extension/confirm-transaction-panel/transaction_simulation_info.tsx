...
type TransactionInfoProps = (
  | {
      simulationType: 'EVM'
      simulation: WootzWallet.EVMSimulationResponse
    }
  | {
      simulationType: 'SVM'
      simulation: WootzWallet.SolanaSimulationResponse
    }
) & {
  network: ChainInfo
    ...
    return simulationType === 'EVM'
      ? {
          evmChanges: groupSimulatedEVMStateChanges(
            expectedStateChanges as WootzWallet.BlowfishEVMStateChange[]
          ),
          svmChanges: undefined
        }
      : {
          svmChanges: decodeSimulatedSVMStateChanges(
            expectedStateChanges as WootzWallet.BlowfishSolanaStateChange[]
          ),
  ...
  return (
    ...
    >
      ...
      {hasAccountOwnershipChanges && (
        ...
        >
          <TransactionChangeCollapseTitle slot='title'>
            {getLocale('wootzWalletOwnershipChange')}
          </TransactionChangeCollapseTitle>
          <TransactionChangeCollapseContent>
      ...
      {hasTransfers ? (
        ...
        >
          <TransactionChangeCollapseTitle slot='title'>
            {getLocale('wootzWalletEstimatedBalanceChange')}
          </TransactionChangeCollapseTitle>
          <TransactionChangeCollapseContent>
      ...
      {hasSolStakingAuthChanges && (
        ...
        >
          <TransactionChangeCollapseTitle slot='title'>
            {getLocale('wootzWalletAuthorityChange')}
          </TransactionChangeCollapseTitle>
          <TransactionChangeCollapseContent>
      ...
      {hasNoChanges && (
        ...
        >
          ...
          <TransactionChangeCollapseContent>
            ...
            <StateChangeText>
              {getLocale('wootzWalletNoChangesDetected')}
            </StateChangeText>
          </TransactionChangeCollapseContent>
        </TransactionChangeCollapse>
      )}
