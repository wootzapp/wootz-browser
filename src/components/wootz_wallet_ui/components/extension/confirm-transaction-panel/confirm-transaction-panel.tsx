    ...
    <StyledWrapper>
      ...
      {isERC20Approve ? (
        <>
          ...
          <PanelTitle>
            {getLocale('wootzWalletAllowSpendTitle').replace(
              '$1',
          ...
          <Description>
            {getLocale('wootzWalletAllowSpendDescription').replace(
              '$1',
              erc20ApproveTokenInfo?.symbol ?? ''
            )}
          </Description>
            ...
            <WarningBox warningType={'danger'}>
              <WarningBoxTitleRow>
                ...
                <WarningTitle warningType={'danger'}>
                  {getLocale('wootzWalletAllowSpendUnlimitedWarningTitle')}
                </WarningTitle>
              </WarningBoxTitleRow>
            </WarningBox>
          )}
          ...
          <EditButton onClick={onToggleEditAllowance}>
            {getLocale('wootzWalletEditPermissionsButton')}
          </EditButton>
        </>
      ) : (
        <>
