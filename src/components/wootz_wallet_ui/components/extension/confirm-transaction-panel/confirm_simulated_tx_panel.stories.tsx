...
const _mockEvmAccountInfos: WootzWallet.AccountInfo[] = [
  {
...
const mockEvmTxInfos: WootzWallet.TransactionInfo[] = [
  deserializeTransaction({
    ...mockTransactionInfo,
...
const evmSimulationResponse: WootzWallet.EVMSimulationResponse = {
  action: WootzWallet.BlowfishSuggestedAction.kBlock,
  warnings: [
    {
      severity: WootzWallet.BlowfishWarningSeverity.kCritical,
      kind: WootzWallet.BlowfishWarningKind.kKnownMalicious,
...
const svmSimulationResponse: WootzWallet.SolanaSimulationResponse = {
  ...mockReceiveSolSimulation,
  action: WootzWallet.BlowfishSuggestedAction.kBlock,
  warnings: [
    {
