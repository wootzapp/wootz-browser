...
export function AddSuggestedTokenPanel() {
  ...
  const suggestion: WootzWallet.AddSuggestTokenRequest | undefined =
    suggestions[0]
  ...
  return (
    <StyledWrapper>
      <TopWrapper>
        ...
        <Title>{getLocale('wootzWalletAddSuggestedTokenTitle')}</Title>
        <URLText>
          {isFetching || !origin ? (
            <LoadingSkeleton
              height={12}
        ...
        <Description>
          {getLocale('wootzWalletAddSuggestedTokenDescription')}
        </Description>
        {isFetching ? (
        ...
        <Tooltip text={getLocale('wootzWalletTransactionExplorer')}>
          <ContractAddress
      ...
      <ButtonWrapper>
        ...
        <NavButton
          disabled={isFetching}
          buttonType='confirm'
          text={getLocale('wootzWalletWatchListAdd')}
          onSubmit={onAddToken}
        />
      </ButtonWrapper>
    </StyledWrapper>
