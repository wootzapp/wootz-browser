...
export const PortfolioAssetItem = ({
  ...
  const { data: bitcoinBalances, isLoading: isLoadingBitcoinBalances } =
    useGetBitcoinBalancesQuery(
      token?.coin === WootzWallet.CoinType.BTC && account?.accountId
        ? account.accountId
        : skipToken
    )
  ...
  const showBalanceInfo =
    hasPendingBalance && account && token.coin === WootzWallet.CoinType.BTC
            ...
            <InfoBar justifyContent='space-between'>
              ...
              >
                ...
                <InfoText
                  ...
                  textAlign='left'
                >
                  {getLocale('wootzWalletUnavailableBalances')}
                </InfoText>
              </Row>
              <div>
                <LeoButton
                ...
                >
                  {getLocale('wootzWalletAllowSpendDetailsButton')}
                </LeoButton>
              </div>
            </InfoBar>
          </Row>
