...
export const NetworkFilterSelector = ({
  ...
  // memos
  const filteredNetworks: WootzWallet.NetworkInfo[] = React.useMemo(() => {
  ...
  const { primaryNetworks, secondaryNetworks, testNetworks } =
    React.useMemo(() => {
      const primaryNetworks: WootzWallet.NetworkInfo[] =
        disableAllAccountsOption ? [] : [AllNetworksOption]
      const secondaryNetworks: WootzWallet.NetworkInfo[] = []
      const testNetworks: WootzWallet.NetworkInfo[] = []
