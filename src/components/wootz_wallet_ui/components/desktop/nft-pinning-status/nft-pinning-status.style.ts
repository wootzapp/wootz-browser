...
export const ContentWrapper = styled.div<{
  pinningStatus: WootzWallet.TokenPinStatusCode
}>`
  ...
  background-color: ${(p) =>
    p.pinningStatus ===
      WootzWallet.TokenPinStatusCode.STATUS_PINNING_IN_PROGRESS ||
    p.pinningStatus === WootzWallet.TokenPinStatusCode.STATUS_PINNING_PENDING
      ? 'var(--uploading-background)'
      : p.pinningStatus === WootzWallet.TokenPinStatusCode.STATUS_PINNED
