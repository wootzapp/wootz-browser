...
export const CryptoView = ({ sessionRoute }: Props) => {
  ...
  const showBanner =
    !isCheckingWallets &&
    (defaultEthereumWallet !== WootzWallet.DefaultWallet.WootzWallet ||
      defaultSolanaWallet !== WootzWallet.DefaultWallet.WootzWallet) &&
    (defaultEthereumWallet !==
      WootzWallet.DefaultWallet.WootzWalletPreferExtension ||
      defaultSolanaWallet !==
        WootzWallet.DefaultWallet.WootzWalletPreferExtension ||
      (defaultEthereumWallet ===
        WootzWallet.DefaultWallet.WootzWalletPreferExtension &&
