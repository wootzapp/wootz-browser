    ...
    >
      ...
      {!isTokenHidden && !isTokenSpam && (
        <>
          <PopupButton onClick={onEditNft}>
            ...
            <PopupButtonText>{getLocale('wootzNftsTabEdit')}</PopupButtonText>
          </PopupButton>
          <PopupButton onClick={onHideNft}>
            <ButtonIcon name='eye-off' />
            <PopupButtonText>{getLocale('wootzNftsTabHide')}</PopupButtonText>
          </PopupButton>
        </>
      )}
      ...
      {isTokenSpam ? (
        ...
        <PopupButton onClick={onUnSpam}>
          ...
          <PopupButtonText>{getLocale('wootzWalletNftUnspam')}</PopupButtonText>
        </PopupButton>
      ) : (
        ...
        <PopupButton onClick={onMarkAsSpam}>
          ...
          <PopupButtonText>
            {getLocale('wootzWalletNftMoveToSpam')}
          </PopupButtonText>
        </PopupButton>
      )}
      ...
      {isTokenHidden && !isTokenSpam ? (
        <PopupButton onClick={onUnHideNft}>
          ...
          <PopupButtonText>{getLocale('wootzNftsTabUnhide')}</PopupButtonText>
        </PopupButton>
      ) : null}
      ...
      <PopupButton onClick={onRemoveNft}>
        ...
        <PopupButtonText>{getLocale('wootzNftsTabRemove')}</PopupButtonText>
      </PopupButton>
    </Popup>
  )
}
