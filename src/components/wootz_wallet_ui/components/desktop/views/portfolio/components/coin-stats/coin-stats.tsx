...
export const CoinStats = (props: Props) => {
  ...
  return (
    <StyledWrapper>
      <DividerText>{getLocale('wootzWalletInformation')}</DividerText>
      <SubDivider />
      <Row>
        <StatWrapper>
          <StatValue>{marketCapRank}</StatValue>
          <StatLabel>{getLocale('wootzWalletRankStat')}</StatLabel>
        </StatWrapper>
        ...
        <StatWrapper>
          ...
          <StatLabel>{getLocale('wootzWalletVolumeStat')}</StatLabel>
        </StatWrapper>
        ...
        <StatWrapper>
          ...
          <StatLabel>{getLocale('wootzWalletMarketCapStat')}</StatLabel>
        </StatWrapper>
      </Row>
    </StyledWrapper>
  )
