...
export const EnableNftDiscoveryModal = ({ onConfirm, onCancel }: Props) => {
  ...
  const { beforeTag, duringTag, afterTag } = splitStringForTag(
    getLocale('wootzWalletEnableNftAutoDiscoveryModalDescription'),
    1
  )
  ...
  return (
    ...
    >
      ...
      >
        <Header>
          {getLocale('wootzWalletEnableNftAutoDiscoveryModalHeader')}
        </Header>
        <Description>
          {beforeTag}
        ...
        <ButtonRow>
          <LeoSquaredButton
            ...
            kind='plain'
          >
            {getLocale('wootzWalletEnableNftAutoDiscoveryModalCancel')}
          </LeoSquaredButton>
          <LeoSquaredButton onClick={onConfirm}>
            {getLocale('wootzWalletEnableNftAutoDiscoveryModalConfirm')}
          </LeoSquaredButton>
        </ButtonRow>
      </Column>
    </PopupModal>
