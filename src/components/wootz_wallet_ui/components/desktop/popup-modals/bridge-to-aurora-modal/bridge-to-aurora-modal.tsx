...
export const BridgeToAuroraModal = ({
  ...
  return (
    ...
    >
      <StyledWrapper>
        <Title>{getLocale('wootzWalletAuroraModalTitle')}</Title>
        <Description>
          {getLocale('wootzWalletAuroraModalDescription')}
        </Description>
        <CheckboxWrapper>
          <Checkbox
          ...
          >
            {getLocale('wootzWalletAuroraModalDontShowAgain')}
          </Checkbox>
        </CheckboxWrapper>
        <OpenRainbowAppButton onClick={onOpenRainbowAppClick}>
          <GlobeIcon />
          <ButtonText>
            {getLocale('wootzWalletAuroraModalOPenButtonText')}
          </ButtonText>
        </OpenRainbowAppButton>
        <LearnMoreLink
          ...
          href={learnMoreLink}
        >
          {getLocale('wootzWalletAuroraModalLearnMore')}
        </LearnMoreLink>
        <LearnMoreLink
          rel='noopener noreferrer'
          target='_blank'
        ...
        >
          {getLocale('wootzWalletAuroraModalLearnMoreAboutRisk')}
        </LearnMoreLink>
      </StyledWrapper>
    </PopupModal>
  )
