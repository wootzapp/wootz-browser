...
const pendingTxTypes = [
  WootzWallet.TransactionStatus.Submitted,
  WootzWallet.TransactionStatus.Unapproved
]

const successTxTypes = [
  WootzWallet.TransactionStatus.Approved,
  WootzWallet.TransactionStatus.Confirmed,
  WootzWallet.TransactionStatus.Signed
]

const errorTxTypes = [
  WootzWallet.TransactionStatus.Error,
  WootzWallet.TransactionStatus.Dropped,
  WootzWallet.TransactionStatus.Rejected
]

interface Props {
  onClose: () => void
  transaction: WootzWallet.TransactionInfo | SerializableTransactionInfo
}
...
export const TransactionDetailsModal = ({ onClose, transaction }: Props) => {
  ...
  const sendToken =
    transaction.txType === WootzWallet.TransactionType.ETHSend ||
    transaction.fromAccountId.coin === WootzWallet.CoinType.FIL ||
    transaction.fromAccountId.coin === WootzWallet.CoinType.BTC ||
    transaction.txType === WootzWallet.TransactionType.SolanaSystemTransfer
      ? networkAsset
      : txToken
  ...
  const formattedSendFiatValue =
    transaction.txType === WootzWallet.TransactionType.ERC20Approve
  ...
  const gasFee =
    txCoinType === WootzWallet.CoinType.SOL
      ? solFeeEstimates ?? ''
      ...
      >
          ...
          >
            <IconAndValue width='unset'>
              ...
              >
                ...
                >
                  {isSolanaSwap
                    ? getLocale('wootzWalletSolanaSwap')
                        ...
                        {isBridgeTx ? (
                          ...
                          >
                            <SwapAmountText
                              ...
                              textAlign='left'
                            >
                              {getLocale('wootzWalletOnNetwork').replace(
                                '$1',
                                toNetwork?.chainName ?? ''
                              )}
                            </SwapAmountText>
          ...
          <>
            <SectionRow padding='16px 0px'>
              <SectionLabel
                ...
                textSize='14px'
              >
                {getLocale('wootzWalletTransactionDetailHash')}
              </SectionLabel>
        ...
        <SectionRow padding='16px 0px 0px 0px'>
          <SectionLabel
            ...
            textSize='14px'
          >
            {getLocale('wootzWalletConfirmTransactionTransactionFee')}
          </SectionLabel>
          <Row width='unset'>
            <SectionInfoText
              textAlign='left'
          ...
          <Row padding='32px 0px 0px 0px'>
            <Row>
              <Button
                ...
                kind='outline'
              >
                {getLocale('wootzWalletTransactionCancel')}
              </Button>
            </Row>
            ...
            <Row>
              <Button onClick={onClickSpeedupTransaction}>
                <Row>
                  <SpeedupIcon />
                  {getLocale('wootzWalletTransactionSpeedup')}
                </Row>
              </Button>
            </Row>
          </Row>
        ...
        {isRetriable && (
          <Row padding='32px 0px 0px 0px'>
            ...
            >
              <Row>
                <RetryIcon />
                {getLocale('wootzWalletTransactionRetry')}
              </Row>
            </Button>
          </Row>
        )}
