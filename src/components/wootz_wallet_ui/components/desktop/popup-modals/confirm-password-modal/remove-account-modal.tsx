...
export const RemoveAccountModal = () => {
  ...
  const onConfirmRemoveAccount = React.useCallback(
    async (password: string) => {
      ...
      if (
        accountId.kind === WootzWallet.AccountKind.kHardware ||
        accountId.kind === WootzWallet.AccountKind.kImported
      ) {
  ...
  return (
    <PopupModal
      title={getLocale('wootzWalletAccountSettingsRemove')}
      ...
      <StyledWrapper>
          ...
          {accountToRemove && (
            ...
            >
              <Text
                ...
                textAlign='left'
              >
                {getLocale('wootzWalletRemoveAccountModalTitle').replace(
                  '$1',
              ...
              <Text
                ...
                textColor={'tertiary'}
              >
                {getLocale('wootzWalletPasswordIsRequiredToTakeThisAction')}
              </Text>
            </Column>
          )}
        ...
        {isMobile || isPanel ? (
          <Row gap='4px'>
            ...
            >
              {getLocale('wootzWalletAccountsRemove')}
            </LeoSquaredButton>
          </Row>
        ) : (
          <Row
