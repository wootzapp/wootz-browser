...
export const PortfolioFiltersModal = ({ onClose, onSave }: Props) => {
  ...
  const hideSmallBalancesDescription = React.useMemo(() => {
    const minAmount = new Amount(HIDE_SMALL_BALANCES_FIAT_THRESHOLD)
      ...
      .split('.')[0]
    return getLocale('wootzWalletHideSmallBalancesDescription').replace(
      '$1',
      minAmount
    )
  }, [defaultFiatCurrency])
  ...
  return (
    <PopupModal
      ...
      title={
        showNftFilters
          ? getLocale('wootzWalletPortfolioNftsFiltersTitle')
          : getLocale('wootzWalletPortfolioFiltersTitle')
      }
      width='500px'
    >
      <ScrollableColumn>
        ...
        >
          {showNftFilters ? (
            <>
              <FilterToggleSection
                title={getLocale('wootzWalletShowNetworkLogoOnNftsTitle')}
              ...
              <FilterToggleSection
                title={getLocale('wootzWalletGroupByCollection')}
                description={getLocale(
              ...
              <FilterToggleSection
                title={getLocale('wootzWalletHideNotOwnedNfTs')}
                description={''}
                icon='web3'
              ...
              {/* <FilterToggleSection
                title={getLocale('wootzWalletShowSpamNftsTitle')}
                description={getLocale('wootzWalletShowSpamNftsDescription')}
                icon='shield-star'
                isSelected={true}
                setIsSelected={
                  () => {}
            ...
            <>
              <FilterDropdownSection
                title={getLocale('wootzWalletPortfolioGroupByTitle')}
                description={getLocale(
                  'wootzWalletPortfolioGroupByDescription'
                )}
                icon='stack'
              ...
              />
              <FilterDropdownSection
                title={getLocale('wootzWalletSortAssets')}
                description={getLocale('wootzWalletSortAssetsDescription')}
                icon='sort-desc'
              ...
              <FilterToggleSection
                title={getLocale('wootzWalletHideSmallBalances')}
