...
interface Props {
  ...
  networksSubset?: WootzWallet.NetworkInfo[]
}
    ...
    <>
      ...
      >
        <Title
          ...
          isBold={true}
        >
          {getLocale('wootzWalletSelectNetworks')}
        </Title>
        <SelectAllButton onClick={onSelectOrDeselectAllNetworks}>
          {isSelectAll
            ? getLocale('wootzWalletSelectAll')
            : getLocale('wootzWalletDeselectAll')}
        </SelectAllButton>
      </Row>
      ...
      {primaryNetworks.length > 0 && (
        <NetworkCheckboxes
          ...
          title={getLocale('wootzWalletPrimaryNetworks')}
          marginBottom={8}
        />
      )}
      ...
      {secondaryNetworks.length > 0 && (
        <NetworkCheckboxes
          ...
          title={getLocale('wootzWalletNetworkFilterSecondary')}
          marginBottom={8}
        />
      )}
      ...
      {testNetworks.length > 0 && (
        <NetworkCheckboxes
          ...
          title={getLocale('wootzWalletNetworkFilterTestNetworks')}
          marginBottom={8}
        />
      )}
