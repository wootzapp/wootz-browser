...
const onlyInLeft = (
  left: WootzWallet.BlockchainToken[],
  right: WootzWallet.BlockchainToken[]
) =>
  left.filter(
    (leftValue) =>
      !right.some(
...
export const EditVisibleAssetsModal = ({ onClose }: Props) => {
  ...
  const [selectedNetworkFilter, setSelectedNetworkFilter] =
    React.useState<WootzWallet.NetworkInfo>(AllNetworksOption)
  ...
  const tokenListForSelectedNetworks: WootzWallet.BlockchainToken[] =
    React.useMemo(() => {
  ...
  const sortedTokenListForSelectedNetworks: WootzWallet.BlockchainToken[] =
    React.useMemo(() => {
    ...
    <PopupModal
      title={
        showAddCustomToken
          ...
          : getLocale('wootzWalletAccountsEditVisibleAssets')
      }
      onClose={onClose}
      width='500px'
          ...
          >
            ...
            >
              {hash === WalletRoutes.AvailableAssetsHash
                ? getLocale('wootzWalletAvailableAssets')
                : getLocale('wootzWalletMyAssets')}
            </Text>
            {hash === WalletRoutes.AvailableAssetsHash && (
                ...
                <EmptyStateWrapper>
                  <Column>
                    ...
                    <Text
                      ...
                      isBold={true}
                    >
                      {getLocale('wootzWalletAssetNotFound')}
                    </Text>
                    ...
                    <Text
                      ...
                      isBold={false}
                    >
                      {getLocale('wootzWalletDidntFindAssetInList')}
                    </Text>
