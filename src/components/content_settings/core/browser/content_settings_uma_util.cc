...
constexpr auto kHistogramValue = base::MakeFixedFlatMap<ContentSettingsType,
    ...
    {ContentSettingsType::FILE_SYSTEM_READ_GUARD, 68},
    {ContentSettingsType::STORAGE_ACCESS, 69},
    {ContentSettingsType::CAMERA_PAN_TILT_ZOOM, 70},
    {ContentSettingsType::WINDOW_MANAGEMENT, 71},
    {ContentSettingsType::INSECURE_PRIVATE_NETWORK, 72},
    {ContentSettingsType::LOCAL_FONTS, 73},
    {ContentSettingsType::PERMISSION_AUTOREVOCATION_DATA, 74},
    {ContentSettingsType::FILE_SYSTEM_LAST_PICKED_DIRECTORY, 75},
    {ContentSettingsType::DISPLAY_CAPTURE, 76},
    // Removed FILE_HANDLING in M98.
    {ContentSettingsType::FILE_SYSTEM_ACCESS_CHOOSER_DATA, 78},
    {ContentSettingsType::FEDERATED_IDENTITY_SHARING, 79},
    // Removed FEDERATED_IDENTITY_REQUEST in M103.
    {ContentSettingsType::JAVASCRIPT_JIT, 81},
    {ContentSettingsType::HTTP_ALLOWED, 82},
    {ContentSettingsType::FORMFILL_METADATA, 83},
    {ContentSettingsType::DEPRECATED_FEDERATED_IDENTITY_ACTIVE_SESSION, 84},
    {ContentSettingsType::AUTO_DARK_WEB_CONTENT, 85},
    {ContentSettingsType::REQUEST_DESKTOP_SITE, 86},
    {ContentSettingsType::FEDERATED_IDENTITY_API, 87},
    {ContentSettingsType::NOTIFICATION_INTERACTIONS, 88},
    {ContentSettingsType::REDUCED_ACCEPT_LANGUAGE, 89},
    {ContentSettingsType::NOTIFICATION_PERMISSION_REVIEW, 90},
    {ContentSettingsType::PRIVATE_NETWORK_GUARD, 91},
    {ContentSettingsType::PRIVATE_NETWORK_CHOOSER_DATA, 92},
    {ContentSettingsType::FEDERATED_IDENTITY_IDENTITY_PROVIDER_SIGNIN_STATUS,
     93},
    {ContentSettingsType::REVOKED_UNUSED_SITE_PERMISSIONS, 94},
    {ContentSettingsType::TOP_LEVEL_STORAGE_ACCESS, 95},
    {ContentSettingsType::FEDERATED_IDENTITY_AUTO_REAUTHN_PERMISSION, 96},
    {ContentSettingsType::FEDERATED_IDENTITY_IDENTITY_PROVIDER_REGISTRATION,
     97},
    {ContentSettingsType::ANTI_ABUSE, 98},
    {ContentSettingsType::THIRD_PARTY_STORAGE_PARTITIONING, 99},
    {ContentSettingsType::HTTPS_ENFORCED, 100},
    {ContentSettingsType::USB_CHOOSER_DATA, 101},
    // The value 100 is assigned to COOKIES!
    // Removed GET_DISPLAY_MEDIA_SET_SELECT_ALL_SCREENS in M116.
    {ContentSettingsType::MIDI, 104},
    {ContentSettingsType::ALL_SCREEN_CAPTURE, 105},
    {ContentSettingsType::COOKIE_CONTROLS_METADATA, 106},
    {ContentSettingsType::TPCD_TRIAL, 107},
    {ContentSettingsType::AUTO_PICTURE_IN_PICTURE, 108},
    {ContentSettingsType::TPCD_METADATA_GRANTS, 109},
    {ContentSettingsType::FILE_SYSTEM_ACCESS_EXTENDED_PERMISSION, 110},
    {ContentSettingsType::TPCD_HEURISTICS_GRANTS, 111},
    {ContentSettingsType::FILE_SYSTEM_ACCESS_RESTORE_PERMISSION, 112},
    {ContentSettingsType::CAPTURED_SURFACE_CONTROL, 113},
    {ContentSettingsType::SMART_CARD_GUARD, 114},
    {ContentSettingsType::SMART_CARD_DATA, 115},
    {ContentSettingsType::WEB_PRINTING, 116},
    {ContentSettingsType::TOP_LEVEL_TPCD_TRIAL, 117},
    {ContentSettingsType::AUTOMATIC_FULLSCREEN, 118},
    {ContentSettingsType::SUB_APP_INSTALLATION_PROMPTS, 119},
    {ContentSettingsType::SPEAKER_SELECTION, 120},
    {ContentSettingsType::DIRECT_SOCKETS, 121},
    {ContentSettingsType::KEYBOARD_LOCK, 122},
    {ContentSettingsType::POINTER_LOCK, 123},
    {ContentSettingsType::REVOKED_ABUSIVE_NOTIFICATION_PERMISSIONS, 124},
    {ContentSettingsType::TRACKING_PROTECTION, 125},
    {ContentSettingsType::TOP_LEVEL_TPCD_ORIGIN_TRIAL, 126},
