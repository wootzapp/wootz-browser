...
impl<'a> Cursor<'a> {
    ...
    unsafe fn create(mut ptr: *const Entry, scope: *const Entry) -> Self {
        ...
        while {
            // SAFETY: The caller of this function is responsible for ensuring ptr is valid.
            unsafe { matches!(*ptr, Entry::End(_)) }
        } {
            if ptr == scope {
                break;
            }
    ...
    unsafe fn bump_ignore_group(self) -> Cursor<'a> {
        // SAFETY: The caller of this function is responsible for ensuring self.ptr is valid.
