...
pub fn generate_parameters<E, C>(circuit: C, g1: E::G1, g2: E::G2, alpha: E::Fr, beta: E::Fr, gamma: E::Fr, delta: E::Fr, tau: E::Fr) -> Result<Parameters<E>, SynthesisError>
where
    E: Engine,
    C: Circuit<E>,
{
    ...
    fn eval<E: Engine>(
        ...
        worker.scope(a.len(), |scope, chunk| {
                ...
                .zip(ct.chunks(chunk))
            {
                ...
                scope.spawn(move |_| {
                    for ((((((a, b_g1), b_g2), ext), at), bt), ct) in a.iter_mut().zip(b_g1.iter_mut()).zip(b_g2.iter_mut()).zip(ext.iter_mut()).zip(at.iter()).zip(bt.iter()).zip(ct.iter()) {
