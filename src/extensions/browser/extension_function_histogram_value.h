...
enum HistogramValue {
  ...
  WOOTZAPP_HELLOWORLD = 1892,
  WOOTZAPP_SHOWCONSENTDIALOGANDMAYBESTARTSERVICE = 1893,
  WOOTZAPP_SHOWDIALOG = 1894,
  WOOTZAPP_LOG = 1895,
  WOOTZAPP_SETJOB = 1896,
  WOOTZAPP_REMOVEJOB = 1897,
  WOOTZAPP_GETJOBS = 1898,
  WOOTZAPP_LISTJOBS = 1899,
  WOOTZAPP_CLEANJOBS = 1900,
  WOOTZAPP_SELECT_CHAIN = 1901,
  WOOTZAPP_CREATE_WALLET = 1902,
  WOOTZAPP_UNLOCK_WALLET = 1903,
  WOOTZAPP_LOCK_WALLET = 1904,
  WOOTZAPP_IS_LOCKED = 1905,
  WOOTZAPP_GET_ALL_ACCOUNTS = 1906,
  WOOTZAPP_SIGN_MESSAGE = 1907,
  WOOTZAPP_IS_WALLET_CREATED = 1908,
  // WOOTZAPP_SEND_TRANSACTION = 1909,
  WOOTZAPP_SIGN_TRANSACTION = 1910,
  WOOTZAPP_SIGN_SOLANA_TRANSACTION = 1911,
  WOOTZAPP_GET_BROWSER_INFO = 1912,
