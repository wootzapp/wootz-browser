...
enum HistogramValue {
  ...
  WOOTZ_INFO = 1937,
  HELLOWORLD_SAYHELLO = 1938,
  WOOTZ_HELLOWORLD = 1939,
  WOOTZ_SHOWCONSENTDIALOGANDMAYBESTARTSERVICE = 1940,
  WOOTZ_SHOWDIALOG = 1941,
  WOOTZ_LOG = 1942,
  WOOTZ_SETJOB = 1943,
  WOOTZ_REMOVEJOB = 1944,
  WOOTZ_GETJOBS = 1945,
  WOOTZ_LISTJOBS = 1946,
  WOOTZ_CLEANJOBS = 1947,
  WOOTZ_SELECT_CHAIN = 1948,
  WOOTZ_CREATE_WALLET = 1949,
  WOOTZ_UNLOCK_WALLET = 1950,
  WOOTZ_LOCK_WALLET = 1951,
  WOOTZ_IS_LOCKED = 1952,
  WOOTZ_GET_ALL_ACCOUNTS = 1953,
  WOOTZ_SIGN_MESSAGE = 1954,
  WOOTZ_IS_WALLET_CREATED = 1955,
  // WOOTZ_SEND_TRANSACTION = 1956,
  WOOTZ_SIGN_TRANSACTION = 1957,
  WOOTZ_SIGN_SOLANA_TRANSACTION = 1958,
  WOOTZ_GET_BROWSER_INFO = 1959,
  WOOTZ_GENERATE_ZK_PROOF = 1960,
