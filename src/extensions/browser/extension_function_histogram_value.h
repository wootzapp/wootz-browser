...
enum HistogramValue {
  ...
  WOOTZ_SET_COPY_PASTE_BLOCKING = 1917,
  WOOTZ_GET_COPY_PASTE_BLOCKING_SETTINGS = 1918,
  WOOTZ_ADD_COPY_PASTE_BLOCKING_DOMAIN = 1919,
  WOOTZ_REMOVE_COPY_PASTE_BLOCKING_DOMAIN = 1920,
  WOOTZ_IS_COPY_PASTE_BLOCKED_FOR_CURRENT_TAB = 1921,
  WOOTZ_ON_COPY_PASTE_SETTINGS_CHANGED = 1922,
