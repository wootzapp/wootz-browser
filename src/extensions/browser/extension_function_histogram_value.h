...
enum HistogramValue {
  ...
  WOOTZ_GET_PAGE_STATE = 1919,
  WOOTZ_PERFORM_ACTION = 1920,
  ...
  WOOTZ_SET_AUTO_SAVE_PAGES = 1926,
  WOOTZ_SET_AUTO_OPEN_OFFLINE_PAGES = 1927,
  WOOTZ_EXPORT_OFFLINE_PAGES = 1928,
  WOOTZ_CLEAR_OFFLINE_PAGES = 1929,
