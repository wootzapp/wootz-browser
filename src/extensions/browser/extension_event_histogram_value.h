...
enum HistogramValue {
  ...
  WOOTZ_ON_SIGN_MESSAGE_REQUESTED = 567,
  WOOTZ_ON_NEW_UNAPPROVED_TX = 568,
  WOOTZ_ON_TRANSACTION_STATUS_CHANGED = 569,
  WOOTZ_ON_SOLANA_SIGN_TRANSACTION_REQUESTED = 570,
