...
enum HistogramValue {
  ...
  WOOTZAPP_ON_SIGN_MESSAGE_REQUESTED = 557,
  WOOTZAPP_ON_NEW_UNAPPROVED_TX = 558,
  WOOTZAPP_ON_TRANSACTION_STATUS_CHANGED = 559,
  WOOTZAPP_ON_SOLANA_SIGN_TRANSACTION_REQUESTED = 560,
