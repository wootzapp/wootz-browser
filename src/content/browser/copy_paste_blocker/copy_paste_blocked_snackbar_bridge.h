#ifndef CONTENT_BROWSER_COPY_PASTE_BLOCKER_COPY_PASTE_BLOCKED_SNACKBAR_BRIDGE_H_
#define CONTENT_BROWSER_COPY_PASTE_BLOCKER_COPY_PASTE_BLOCKED_SNACKBAR_BRIDGE_H_
