...
std::string ContentBrowserClient::GetBlockedDomainErrorPage() {
  return "<html><body><h1>Access Blocked</h1><p>This website has been blocked by your organization.</p></body></html>";
}

bool ContentBrowserClient::ShouldBlockFileUpload(
    BrowserContext* browser_context,
