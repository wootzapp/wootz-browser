...
class _WebViewTabState extends State<WebViewTab> with WidgetsBindingObserver {
  ...
  late WebNotificationController webNotificationController;
                        ...
                        onWebViewCreated: (controller) async {
                          ...
                          _controller!.addJavaScriptHandler(
                            ...
                            callback: (args) async {
                              ...
                              final mnemonic = tabProfile;

                              // int chainId = pref.get(dappChainIdKey);
                              int chainId = tabChainId;
                              ...
                              print('sending address-> $sendingAddress');
                              final id = args[0];
                              try {
                              ...
                              if (switchChainIdData == null) {
                                ...
                                switchChainIdData = {
                                  ...
                                  'blockExplorer': blockExplorers.isNotEmpty
                                      ...
                                      : null,
                                  'symbol': dataValue['nativeCurrency']
                                      ['symbol'],
                                  'default': dataValue['nativeCurrency']
                                      ['symbol'],
                          ...
                          _controller!.addJavaScriptHandler(
                            ...
                            callback: (args) async {
                              ...
                              // int chainId = pref.get(dappChainIdKey);
                              int chainId = tabChainId;
                              final rpc = getEthereumDetailsFromChainId(
                                  chainId)!['rpc'];
                              final id = args[0];
                              ...
                              try {
                                ...
                                final response = await client.callRaw(
                                  sender:
                                      EthereumAddress.fromHex(sendingAddress),
